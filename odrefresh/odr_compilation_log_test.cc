...
TEST(OdrCompilationLog, ShouldAttemptCompile) {
  ...
  ASSERT_TRUE(ocl.ShouldAttemptCompile(1, 0, OdrMetrics::Trigger::kMissingArtifacts, 0));
  ...
  ASSERT_TRUE(ocl.ShouldAttemptCompile(2, 0, OdrMetrics::Trigger::kApexVersionMismatch));
  ASSERT_FALSE(ocl.ShouldAttemptCompile(1, 0, OdrMetrics::Trigger::kApexVersionMismatch));
  ASSERT_TRUE(ocl.ShouldAttemptCompile(1, 0, OdrMetrics::Trigger::kDexFilesChanged));
  ASSERT_FALSE(ocl.ShouldAttemptCompile(1, 0, OdrMetrics::Trigger::kUnknown));
}
