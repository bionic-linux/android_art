...
typedef std::vector<std::unique_ptr<PositionInfo>> PositionInfoVector;
...
typedef std::vector<std::unique_ptr<LocalInfo>> LocalInfoVector;
...
class AnnotationSetItem : public Item {
 public:
  AnnotationSetItem(AnnotationItemVector* items) : items_(items) { }
