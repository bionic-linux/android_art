...
#
# Also include:
# - a copy of the ICU .dat prebuilt files in /system/etc/tzdata_module/etc/icu
#   on target (see module `icu_overlay-art-test-tzdata`); and
# - a copy of the timezones prebuilt files in /system/etc/tzdata_module/etc/tz
#   on target, (see modules `tzdata-art-test-tzdata`,
#   `tzlookup.xml-art-test-tzdata`, and `tz_version-art-test-tzdata`)
