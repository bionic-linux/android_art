...
class DexoptAnalyzerTest : public DexoptTest {
 protected:
  ...
  int CheckBootImage(const std::initializer_list<std::string>& options = {}) {
    ...
    std::vector<std::string> argv_str;
    argv_str.push_back(dexoptanalyzer_cmd);
    argv_str.push_back("--check-boot-image");
...
TEST_F(DexoptAnalyzerTest, CheckBootImageOK) {
  ...
  EXPECT_EQ(static_cast<int>(dexoptanalyzer::ExitStatus::kNoDexOptNeeded), result);
}
...
TEST_F(DexoptAnalyzerTest, CheckBootImageEmptyCache) {
  ...
  EXPECT_EQ(static_cast<int>(dexoptanalyzer::ExitStatus::kBootImageError), result);
...
TEST_F(DexoptAnalyzerTest, CheckBootImageMissingData) {
  ...
  EXPECT_NE(static_cast<int>(dexoptanalyzer::ExitStatus::kNoDexOptNeeded), result);
}
