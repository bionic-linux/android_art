...
// Validate that the server side condig is picked when it is set.
TEST_F(FlagsTests, FlagsTestsGetValue) {
...
TEST_F(FlagsTests, FlagsTestsGetValueSysProperty) {
  android::base::SetProperty("dalvik.vm.my-feature-test.flag", "2");
