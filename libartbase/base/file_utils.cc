...
std::string GetAndroidRootSafe(std::string* error_msg) {
  ...
  *error_msg = "GetAndroidRootSafe unsupported for Windows.";
  ...
  std::string path = GetAndroidDirSafe(kAndroidRootEnvVar, kAndroidRootDefaultPath,
      /*must_exists=*/ false, &local_error_msg);
  if (path.empty()) {
...
std::string GetSystemExtRootSafe(std::string* error_msg) {
  ...
  *error_msg = "GetSystemExtRootSafe unsupported for Windows.";
  return "";
#else
  return GetAndroidDirSafe(kAndroidSystemExtRootEnvVar, kAndroidSystemExtRootDefaultPath,
      /*must_exists=*/ false, error_msg);
#endif
}
