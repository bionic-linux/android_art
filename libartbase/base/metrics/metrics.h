...
#define ART_METRICS(METRIC)                                             \
  ...
  METRIC(WorldStopTimeDuringGcSum, MetricsCounter)                      \
  METRIC(WorldStopTimeDuringGcCount, MetricsCounter)                    \
  METRIC(YoungGcThroughputSum, MetricsCounter)                          \
  METRIC(YoungGcThroughputCount, MetricsCounter)                        \
  METRIC(FullGcThroughputSum, MetricsCounter)                           \
  METRIC(FullGcThroughputCount, MetricsCounter)                         \
  METRIC(YoungGcTracingThroughputSum, MetricsCounter)                   \
  METRIC(YoungGcTracingThroughputCount, MetricsCounter)                 \
  METRIC(FullGcTracingThroughputSum, MetricsCounter)                    \
  METRIC(FullGcTracingThroughputCount, MetricsCounter)
