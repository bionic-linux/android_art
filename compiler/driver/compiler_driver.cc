  ...
  if (driver->GetCurrentDexToDexMethods() != nullptr) {
    ...
    if (!driver->GetCompilerOptions().IsJniCompilationEnabled() &&
      ...
      if (annotation_set != nullptr) {
        bool fast_native = annotations::IsFastNativeMethodAnnotationPresent(
            dex_file, *annotation_set);
        bool critical_native = annotations::IsCriticalNativeMethodAnnotationPresent(
            dex_file, *annotation_set);
