...
TEST_F(AssemblerRISCV64Test, Xori_WithoutC) {
  ScopedCSuppression scs(this);
  DriverStr(RepeatRRIb(&Riscv64Assembler::Xori, -11, "xori {reg1}, {reg2}, {imm}"),
            "Xori_WithoutC");
}
...
TEST_F(AssemblerRISCV64Test, SextH_WithoutZbb) {
  ScopedZbbSuppression scs(this);
  DriverStr(
      RepeatRR(&Riscv64Assembler::SextH, "slli {reg1}, {reg2}, 48\nsrai {reg1}, {reg1}, 48\n"),
      "SextH_WithoutZbb");
}
...
TEST_F(AssemblerRISCV64Test, ZextW_WithoutZba) {
  ...
  DriverStr(
      RepeatRR(&Riscv64Assembler::ZextW, "slli {reg1}, {reg2}, 32\nsrli {reg1}, {reg1}, 32\n"),
      "ZextW_WithoutZba");
}
