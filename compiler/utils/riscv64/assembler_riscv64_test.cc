 ...
 protected:
  ...
  void SetUpHelpers() override {
    if (registers_.size() == 0) {
      registers_.push_back(Zero);
      registers_.push_back(RA);
      registers_.push_back(SP);
      registers_.push_back(GP);
      registers_.push_back(TP);
      registers_.push_back(T0);
      registers_.push_back(T1);
      registers_.push_back(T2);
      registers_.push_back(S0);
      registers_.push_back(S1);
      registers_.push_back(A0);
      registers_.push_back(A1);
      registers_.push_back(A2);
      registers_.push_back(A3);
      registers_.push_back(A4);
      registers_.push_back(A5);
      registers_.push_back(A6);
      registers_.push_back(A7);
      registers_.push_back(S2);
      registers_.push_back(S3);
      registers_.push_back(S4);
      registers_.push_back(S5);
      registers_.push_back(S6);
      registers_.push_back(S7);
      registers_.push_back(S8);
      registers_.push_back(S9);
      registers_.push_back(S10);
      registers_.push_back(S11);
      ...
      fp_registers_.push_back(FT0);
      fp_registers_.push_back(FT1);
      fp_registers_.push_back(FT2);
      fp_registers_.push_back(FT3);
      fp_registers_.push_back(FT4);
      fp_registers_.push_back(FT5);
      fp_registers_.push_back(FT6);
      fp_registers_.push_back(FT7);
      fp_registers_.push_back(FS0);
      fp_registers_.push_back(FS1);
      fp_registers_.push_back(FA0);
      fp_registers_.push_back(FA1);
      fp_registers_.push_back(FA2);
      fp_registers_.push_back(FA3);
      fp_registers_.push_back(FA4);
      fp_registers_.push_back(FA5);
      fp_registers_.push_back(FA6);
      fp_registers_.push_back(FA7);
      fp_registers_.push_back(FS2);
      fp_registers_.push_back(FS3);
      fp_registers_.push_back(FS4);
      fp_registers_.push_back(FS5);
      fp_registers_.push_back(FS6);
      fp_registers_.push_back(FS7);
      fp_registers_.push_back(FS8);
      fp_registers_.push_back(FS9);
      fp_registers_.push_back(FS10);
      fp_registers_.push_back(FS11);
      fp_registers_.push_back(FT8);
      fp_registers_.push_back(FT9);
      fp_registers_.push_back(FT10);
      fp_registers_.push_back(FT11);
    }
  }
  ...
  ArrayRef<const XRegister> GetRegisters() override {
    return ArrayRef<const XRegister>(registers_);
  }

  ArrayRef<const FRegister> GetFPRegisters() override {
    return ArrayRef<const FRegister>(fp_registers_);
  }
