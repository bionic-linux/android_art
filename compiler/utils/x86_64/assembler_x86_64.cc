...
void X86_64Assembler::SetX86_64InstructionSetFeatureFlags(bool has_AVX_flag, bool has_AVX2_flag) {
  has_AVX_ = has_AVX_flag;
  has_AVX2_ = has_AVX2_flag;
}
...
void X86_64Assembler::vmovaps(XmmRegister dst, XmmRegister src) {
  ...
  if (is_twobyte_form) {
    ...
    byte_one = EmitVexPrefixByteOne(rex_bit, vvvv_reg,
                                    SET_VEX_L_128, SET_VEX_PP_NONE);
  } else {
    byte_one = EmitVexPrefixByteOne(dst.NeedsRex(), false, src.NeedsRex(),
                                    SET_VEX_M_0F);
    byte_two = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
                                    SET_VEX_PP_NONE);
  }
  EmitUint8(byte_zero);
  EmitUint8(byte_one);
...
void X86_64Assembler::vmovaps(XmmRegister dst, const Address& src) {
  ...
  if (is_twobyte_form) {
    X86_64ManagedRegister vvvv_reg = ManagedRegister::NoRegister().AsX86_64();
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), vvvv_reg, SET_VEX_L_128,
                                   SET_VEX_PP_NONE);
  } else {
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), Rex_x /*VEX.X*/, Rex_b /*VEX.B*/,
                                   SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
                                   SET_VEX_PP_NONE);
  }
  EmitUint8(ByteZero);
  EmitUint8(ByteOne);
...
void X86_64Assembler::vmovaps(const Address& dst, XmmRegister src) {
  ...
  if (is_twobyte_form) {
    X86_64ManagedRegister vvvv_reg = ManagedRegister::NoRegister().AsX86_64();
    ByteOne = EmitVexPrefixByteOne(src.NeedsRex(), vvvv_reg, SET_VEX_L_128,
                                   SET_VEX_PP_NONE);
  } else {
    ByteOne = EmitVexPrefixByteOne(src.NeedsRex() /*VEX.R*/, Rex_x /*VEX.X*/,
                                   Rex_b /*VEX.B*/, SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128, SET_VEX_PP_NONE);
  }
  EmitUint8(ByteZero);
  EmitUint8(ByteOne);
  if (!is_twobyte_form) {
...
void X86_64Assembler::vmovups(const Address& dst, XmmRegister src) {
  ...
  if (is_twobyte_form) {
    ...
    ByteOne = EmitVexPrefixByteOne(src.NeedsRex(), Rex_x /*VEX.X*/,
                                   Rex_b /*VEX.B*/, SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
                                   SET_VEX_PP_NONE);
  }
...
void X86_64Assembler::vmovapd(XmmRegister dst, XmmRegister src) {
  ...
  if (is_twobyte_form) {
    X86_64ManagedRegister vvvv_reg = ManagedRegister::NoRegister().AsX86_64();
    bool rex_bit = load ? dst.NeedsRex() : src.NeedsRex();
    ByteOne = EmitVexPrefixByteOne(rex_bit, vvvv_reg, SET_VEX_L_128,
                                   SET_VEX_PP_66);
  } else {
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), false /*VEX.X*/,
                                   src.NeedsRex(), SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
                                   SET_VEX_PP_66);
  }
  EmitUint8(ByteZero);
...
void X86_64Assembler::vmovapd(XmmRegister dst, const Address& src) {
  ...
  if (is_twobyte_form) {
    ...
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), Rex_x /*VEX.X*/,
                                   Rex_b /*VEX.B*/, SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
                                   SET_VEX_PP_66);
  }
...
void X86_64Assembler::vmovupd(XmmRegister dst, const Address& src) {
  ...
  if (is_twobyte_form) {
    X86_64ManagedRegister vvvv_reg = ManagedRegister::NoRegister().AsX86_64();
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), vvvv_reg,
                                   SET_VEX_L_128, SET_VEX_PP_66);
  } else {
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), Rex_x /*VEX.X*/,
                                   Rex_b /*VEX.B*/, SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
...
void X86_64Assembler::vmovapd(const Address& dst, XmmRegister src) {
  ...
  if (is_twobyte_form) {
    X86_64ManagedRegister vvvv_reg = ManagedRegister::NoRegister().AsX86_64();
    ByteOne = EmitVexPrefixByteOne(src.NeedsRex(), vvvv_reg,
                                   SET_VEX_L_128, SET_VEX_PP_66);
  } else {
    ByteOne = EmitVexPrefixByteOne(src.NeedsRex() /*VEX.R*/, Rex_x /*VEX.X*/,
                                   Rex_b/*VEX.B*/, SET_VEX_M_0F);
...
void X86_64Assembler::vmovupd(const Address& dst, XmmRegister src) {
  ...
  if (is_twobyte_form) {
    ...
    ByteOne = EmitVexPrefixByteOne(src.NeedsRex() /*VEX.R*/, Rex_x /*VEX.X*/,
                                   Rex_b /*VEX.B*/, SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/,
                                   SET_VEX_L_128, SET_VEX_PP_66);
  }
  EmitUint8(ByteZero);
  EmitUint8(ByteOne);
...
void X86_64Assembler::vmovdqa(XmmRegister dst, XmmRegister src) {
  ...
  if (is_twobyte_form) {
    X86_64ManagedRegister vvvv_reg = ManagedRegister::NoRegister().AsX86_64();
    bool rex_bit = load ? dst.NeedsRex() : src.NeedsRex();
    ByteOne = EmitVexPrefixByteOne(rex_bit, vvvv_reg,
                                   SET_VEX_L_128, SET_VEX_PP_66);
  } else {
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), false,
                                   src.NeedsRex(), SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
                                   SET_VEX_PP_66);
  }
...
void X86_64Assembler::vmovdqa(XmmRegister dst, const Address& src) {
  ...
  if (is_twobyte_form) {
    ...
    ByteOne = EmitVexPrefixByteOne(dst.NeedsRex(), Rex_x,
                                   Rex_b, SET_VEX_M_0F);
    ByteTwo = EmitVexPrefixByteTwo(false/*VEX.W*/, SET_VEX_L_128,
                                   SET_VEX_PP_66);
  }
...
void X86_64Assembler::andn(CpuRegister dst, CpuRegister src1, CpuRegister src2) {
  ...
  uint8_t byte_one = EmitVexPrefixByteOne(dst.NeedsRex(), false,
                                          src2.NeedsRex(), SET_VEX_M_0F_38);
  uint8_t byte_two = EmitVexPrefixByteTwo(true, X86_64ManagedRegister::FromCpuRegister(src1.AsRegister()),
                                          SET_VEX_L_128, SET_VEX_PP_NONE);
  EmitUint8(byte_zero);
  EmitUint8(byte_one);
  EmitUint8(byte_two);
...
void X86_64Assembler::blsi(CpuRegister dst, CpuRegister src) {
  AssemblerBuffer::EnsureCapacity ensured(&buffer_);
  uint8_t byte_zero = EmitVexPrefixByteZero(false /*is_two_byte*/);
  uint8_t byte_one = EmitVexPrefixByteOne(false, false, src.NeedsRex(), SET_VEX_M_0F_38);
  uint8_t byte_two = EmitVexPrefixByteTwo(true, X86_64ManagedRegister::FromCpuRegister(dst.AsRegister()),
                                          SET_VEX_L_128, SET_VEX_PP_NONE);
  EmitUint8(byte_zero);
  EmitUint8(byte_one);
  EmitUint8(byte_two);
...
uint8_t X86_64Assembler::EmitVexPrefixByteOne(bool R, X86_64ManagedRegister operand, int SET_VEX_L, int SET_VEX_PP) {
  // Vex Byte 1,
  uint8_t vex_prefix = VEX_INIT;
  /** Bit[7] This bit needs to be set to '1'
  otherwise the instruction is LES or LDS */
...
uint8_t X86_64Assembler::EmitVexPrefixByteTwo(bool W, X86_64ManagedRegister operand, int SET_VEX_L, int SET_VEX_PP) {
  // Vex Byte 2,
  uint8_t vex_prefix = VEX_INIT;

  /** Bit[7] This bits needs to be set to '1' with default value.
  When using C4H form of VEX prefix, VEX.W value is ignored */
  if (W) {
...
uint8_t X86_64Assembler::EmitVexPrefixByteTwo(bool W, int SET_VEX_L, int SET_VEX_PP) {
  // Vex Byte 2,
  uint8_t vex_prefix = VEX_INIT;
