...
TEST(StringReference, ValueComparator) {
  ...
  std::unique_ptr<const IDexFile> dex_file1 = builder1.Build("dummy location 1");
  ...
  std::unique_ptr<const IDexFile> dex_file2 = builder2.Build("dummy location 2");
...
TEST(StringReference, ValueComparator2) {
  ...
  std::unique_ptr<const IDexFile> dex_file2 = builder2.Build("dummy location 1");
