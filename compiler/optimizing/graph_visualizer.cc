 ...
 public:
  ...
  void VisitArraySet(HArraySet* array_set) override {
    ...
    StartAttributeStream("can_trigger_gc")
        ...
        << std::noboolalpha;
    StartAttributeStream("maybe_generate_write_barrier")
        << std::boolalpha << array_set->GetMaybeGenerateWriteBarrier() << std::noboolalpha;
  }
  ...
  void VisitInstanceFieldSet(HInstanceFieldSet* iset) override {
    ...
    StartAttributeStream("maybe_generate_write_barrier")
        << std::boolalpha << iset->GetMaybeGenerateWriteBarrier() << std::noboolalpha;
    StartAttributeStream("write_barrier_being_relied_on")
        << std::boolalpha << iset->GetAlwaysGenerateWriteBarrier() << std::noboolalpha;
  }
  ...
  void VisitStaticFieldSet(HStaticFieldSet* sset) override {
    ...
    StartAttributeStream("maybe_generate_write_barrier")
        << std::boolalpha << sset->GetMaybeGenerateWriteBarrier() << std::noboolalpha;
    StartAttributeStream("write_barrier_being_relied_on")
        << std::boolalpha << sset->GetAlwaysGenerateWriteBarrier() << std::noboolalpha;
  }
