...
static void GenUnsafeGetAbsolute(HInvoke* invoke,
  ...
  DCHECK((type == DataType::Type::kInt8) ||
         ...
         (type == DataType::Type::kReference));
  LocationSummary* locations = invoke->GetLocations();
  Location address_loc = locations->InAt(2);
...
void IntrinsicLocationsBuilderRISCV64::VisitUnsafePutByteAbsolute(HInvoke* invoke) {
...
void IntrinsicCodeGeneratorRISCV64::VisitUnsafePutByteAbsolute(HInvoke* invoke) {
  VisitJdkUnsafePutByteAbsolute(invoke);
}
...
void IntrinsicLocationsBuilderRISCV64::VisitJdkUnsafePutByteAbsolute(HInvoke* invoke) {
  CreateUnsafePutAbsoluteLocations(allocator_, invoke);
}
...
void IntrinsicCodeGeneratorRISCV64::VisitJdkUnsafePutByteAbsolute(HInvoke* invoke) {
  GenUnsafePutAbsolute(invoke, codegen_, std::memory_order_relaxed, DataType::Type::kInt8);
}
