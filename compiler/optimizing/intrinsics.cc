...
bool IntrinsicVisitor::CheckIntegerCacheFields(ObjPtr<mirror::ObjectArray<mirror::Object>> cache) {
  ObjPtr<mirror::Class> cache_class = WellKnownClasses::java_lang_Integer_IntegerCache_cache.Get();
  ...
  ObjPtr<mirror::Class> integer_class = WellKnownClasses::java_lang_Integer_valueOf.Get();
