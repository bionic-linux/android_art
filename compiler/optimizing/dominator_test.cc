...
TEST_F(OptimizerTest, ReturnVoid) {
  const std::vector<uint16_t> data =
      ZERO_REGISTER_CODE_ITEM(Instruction::RETURN_VOID);  // Block number 1

  const uint32_t dominators[] = {kInvalidBlockId, 0, 1};
...
TEST_F(OptimizerTest, CFG1) {
  const std::vector<uint16_t> data =
      ZERO_REGISTER_CODE_ITEM(Instruction::GOTO | 0x100,  // Block number 1
                              Instruction::RETURN_VOID);  // Block number 2

  const uint32_t dominators[] = {kInvalidBlockId, 0, 1, 2};
...
TEST_F(OptimizerTest, CFG2) {
  ...
  const uint32_t dominators[] = {kInvalidBlockId, 0, 1, 2, 3};
...
TEST_F(OptimizerTest, CFG3) {
  const std::vector<uint16_t> data1 =
      ZERO_REGISTER_CODE_ITEM(Instruction::GOTO | 0x200,    // Block number 1
                              Instruction::RETURN_VOID,     // Block number 2
                              Instruction::GOTO | 0xFF00);  // Block number 3

  const uint32_t dominators[] = {kInvalidBlockId, 0, 3, 1, 2};
...
TEST_F(OptimizerTest, CFG4) {
  ...
  const uint32_t dominators[] = {kInvalidBlockId, 3, kInvalidBlockId, 0};
...
TEST_F(OptimizerTest, CFG5) {
  ...
  const uint32_t dominators[] = {kInvalidBlockId, 0, kInvalidBlockId, 1};
