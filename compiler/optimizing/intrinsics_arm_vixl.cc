...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafeGetByte(HInvoke* invoke) {
  CreateUnsafeGetLocations(invoke, codegen_, DataType::Type::kUint8, /*atomic=*/ false);
}

void IntrinsicCodeGeneratorARMVIXL::VisitJdkUnsafeGetByte(HInvoke* invoke) {
  GenUnsafeGet(
      invoke, codegen_, DataType::Type::kUint8, std::memory_order_relaxed, /*atomic=*/ false);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafePutByte(HInvoke* invoke) {
  CreateUnsafePutLocations(invoke, codegen_, DataType::Type::kUint8, /*atomic=*/ false);
}
