...
static void GenerateIntrinsicGet(HInvoke* invoke,
  ...
  // If the destination is expressed as base+offset then we may need to store
  // the absolute destination address in a temporary register.
  UseScratchRegisterScope temps(assembler->GetVIXLAssembler());
  vixl32::Register temp_reg_absolute_address;
  switch (type) {
    case DataType::Type::kInt64:
    case DataType::Type::kReference:
    case DataType::Type::kFloat32:
    case DataType::Type::kFloat64:
      temp_reg_absolute_address = temps.Acquire();
  ...
  MemOperand absolute_address = temp_reg_absolute_address.IsValid()
                                     ? MemOperand(temp_reg_absolute_address)
                                     : address;
...
void IntrinsicLocationsBuilderARMVIXL::VisitUnsafeGetLongAbsolute(HInvoke* invoke) {
  VisitJdkUnsafeGetLongAbsolute(invoke);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitUnsafeGetLongAbsolute(HInvoke* invoke) {
  VisitJdkUnsafeGetLongAbsolute(invoke);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitUnsafeGetByteAbsolute(HInvoke* invoke) {
  VisitJdkUnsafeGetByteAbsolute(invoke);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitUnsafeGetByteAbsolute(HInvoke* invoke) {
  VisitJdkUnsafeGetByteAbsolute(invoke);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafeGetAbsolute(HInvoke* invoke) {
  CreateUnsafeGetAbsoluteLocations(invoke, codegen_, DataType::Type::kInt32, /*atomic=*/ false);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafeGetLongAbsolute(HInvoke* invoke) {
  CreateUnsafeGetAbsoluteLocations(invoke, codegen_, DataType::Type::kInt64, /*atomic=*/ false);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitJdkUnsafeGetLongAbsolute(HInvoke* invoke) {
  GenUnsafeGetAbsolute(
      invoke, codegen_, DataType::Type::kInt64, std::memory_order_relaxed, /*atomic=*/ false);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafeGetByteAbsolute(HInvoke* invoke) {
  CreateUnsafeGetAbsoluteLocations(invoke, codegen_, DataType::Type::kInt8, /*atomic=*/ false);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitJdkUnsafeGetByteAbsolute(HInvoke* invoke) {
  GenUnsafeGetAbsolute(
      invoke, codegen_, DataType::Type::kInt8, std::memory_order_relaxed, /*atomic=*/ false);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitUnsafePutLongAbsolute(HInvoke* invoke) {
  VisitJdkUnsafePutLongAbsolute(invoke);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitUnsafePutLongAbsolute(HInvoke* invoke) {
  VisitJdkUnsafePutLongAbsolute(invoke);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitUnsafePutByteAbsolute(HInvoke* invoke) {
  VisitJdkUnsafePutByteAbsolute(invoke);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitUnsafePutByteAbsolute(HInvoke* invoke) {
  VisitJdkUnsafePutByteAbsolute(invoke);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafePutByteAbsolute(HInvoke* invoke) {
  CreateUnsafePutAbsoluteLocations(invoke, codegen_, DataType::Type::kInt8, /*atomic=*/ false);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitJdkUnsafePutByteAbsolute(HInvoke* invoke) {
  GenUnsafePutAbsolute(invoke,
                       DataType::Type::kInt8,
                       std::memory_order_relaxed,
                       /*atomic=*/false,
...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafePutLongAbsolute(HInvoke* invoke) {
  CreateUnsafePutAbsoluteLocations(invoke, codegen_, DataType::Type::kInt64, /*atomic=*/ false);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitJdkUnsafePutLongAbsolute(HInvoke* invoke) {
  GenUnsafePutAbsolute(invoke,
                       DataType::Type::kInt64,
                       std::memory_order_relaxed,
                       /*atomic=*/false,
