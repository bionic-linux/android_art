...
static bool IntrinsicOnCallList(Intrinsics intrinsic) {
  switch (intrinsic) {
...
static void CreateUnsafeGetLocations(HInvoke* invoke,
                                     ...
                                     DataType::Type type,
                                     bool atomic) {
  bool can_call = kEmitCompilerReadBarrier && IntrinsicOnCallList(invoke->GetIntrinsic());
...
void IntrinsicLocationsBuilderARMVIXL::VisitJdkUnsafeCompareAndSetLong(HInvoke* invoke) {
  CreateUnsafeCASLocations(allocator_, invoke);
}
...
void IntrinsicCodeGeneratorARMVIXL::VisitJdkUnsafeCompareAndSetLong(HInvoke* invoke) {
