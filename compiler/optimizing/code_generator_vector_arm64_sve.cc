...
void LocationsBuilderARM64Sve::VisitVecReplicateScalar(HVecReplicateScalar* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    ...
    case DataType::Type::kFloat64:
      ...
      break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecExtractScalar(HVecExtractScalar* instruction) {
  ...
  ValidateVectorLength(instruction);
  switch (instruction->GetPackedType()) {
    case DataType::Type::kInt32: __ Umov(OutputRegister(instruction), src.V4S(), 0); break;
    case DataType::Type::kInt64: __ Umov(OutputRegister(instruction), src.V2D(), 0); break;
    case DataType::Type::kFloat32:
    case DataType::Type::kFloat64:
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kInt32:
      switch (instruction->GetReductionKind()) {
        case HVecReduce::kSum: __ Saddv(dst.S(), p_reg, src.VnS()); break;
        default: LOG(FATAL) << "Unsupported SIMD instruction"; UNREACHABLE();
      }
      break;
    case DataType::Type::kInt64:
      switch (instruction->GetReductionKind()) {
        case HVecReduce::kSum: __ Uaddv(dst.D(), p_reg, src.VnD()); break;
        default: LOG(FATAL) << "Unsupported SIMD instruction"; UNREACHABLE();
      }
      break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
...
void InstructionCodeGeneratorARM64Sve::VisitVecNeg(HVecNeg* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Neg(dst.VnB(), p_reg, src.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Neg(dst.VnH(), p_reg, src.VnH()); break;
    case DataType::Type::kInt32: __ Neg(dst.VnS(), p_reg, src.VnS()); break;
    case DataType::Type::kInt64: __ Neg(dst.VnD(), p_reg, src.VnD()); break;
    case DataType::Type::kFloat32: __ Fneg(dst.VnS(), p_reg, src.VnS()); break;
    case DataType::Type::kFloat64: __ Fneg(dst.VnD(), p_reg, src.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecAbs(HVecAbs* instruction) {
  ...
  ValidateVectorLength(instruction);
  switch (instruction->GetPackedType()) {
    case DataType::Type::kInt8: __ Abs(dst.VnB(), p_reg, src.VnB()); break;
    case DataType::Type::kInt16: __ Abs(dst.VnH(), p_reg, src.VnH()); break;
    case DataType::Type::kInt32: __ Abs(dst.VnS(), p_reg, src.VnS()); break;
    case DataType::Type::kInt64: __ Abs(dst.VnD(), p_reg, src.VnD()); break;
    case DataType::Type::kFloat32: __ Fabs(dst.VnS(), p_reg, src.VnS()); break;
    case DataType::Type::kFloat64: __ Fabs(dst.VnD(), p_reg, src.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecNot(HVecNot* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kBool:  // special case boolean-not
      ...
      break;
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Not(dst.VnB(), p_reg, src.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Not(dst.VnH(), p_reg, src.VnH()); break;
    case DataType::Type::kInt32: __ Not(dst.VnS(), p_reg, src.VnS()); break;
    case DataType::Type::kInt64: __ Not(dst.VnD(), p_reg, src.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecAdd(HVecAdd* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Add(dst.VnB(), p_reg, lhs.VnB(), rhs.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Add(dst.VnH(), p_reg, lhs.VnH(), rhs.VnH()); break;
    case DataType::Type::kInt32: __ Add(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kInt64: __ Add(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    case DataType::Type::kFloat32:
...
void InstructionCodeGeneratorARM64Sve::VisitVecSub(HVecSub* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Sub(dst.VnB(), p_reg, lhs.VnB(), rhs.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Sub(dst.VnH(), p_reg, lhs.VnH(), rhs.VnH()); break;
    case DataType::Type::kInt32: __ Sub(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kInt64: __ Sub(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    case DataType::Type::kFloat32: __ Fsub(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kFloat64: __ Fsub(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecMul(HVecMul* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Mul(dst.VnB(), p_reg, lhs.VnB(), rhs.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Mul(dst.VnH(), p_reg, lhs.VnH(), rhs.VnH()); break;
    case DataType::Type::kInt32: __ Mul(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kInt64: __ Mul(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    case DataType::Type::kFloat32:
...
void InstructionCodeGeneratorARM64Sve::VisitVecDiv(HVecDiv* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kFloat32: __ Fdiv(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kFloat64: __ Fdiv(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecAnd(HVecAnd* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kBool:
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ And(dst.VnB(), p_reg, lhs.VnB(), rhs.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ And(dst.VnH(), p_reg, lhs.VnH(), rhs.VnH()); break;
    case DataType::Type::kInt32:
    case DataType::Type::kFloat32: __ And(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kInt64:
    case DataType::Type::kFloat64: __ And(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecOr(HVecOr* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kBool:
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Orr(dst.VnB(), p_reg, lhs.VnB(), rhs.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Orr(dst.VnH(), p_reg, lhs.VnH(), rhs.VnH()); break;
    case DataType::Type::kInt32:
    case DataType::Type::kFloat32: __ Orr(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kInt64:
    case DataType::Type::kFloat64: __ Orr(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecXor(HVecXor* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kBool:
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Eor(dst.VnB(), p_reg, lhs.VnB(), rhs.VnB()); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Eor(dst.VnH(), p_reg, lhs.VnH(), rhs.VnH()); break;
    case DataType::Type::kInt32:
    case DataType::Type::kFloat32: __ Eor(dst.VnS(), p_reg, lhs.VnS(), rhs.VnS()); break;
    case DataType::Type::kInt64:
    case DataType::Type::kFloat64: __ Eor(dst.VnD(), p_reg, lhs.VnD(), rhs.VnD()); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecShl(HVecShl* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Lsl(dst.VnB(), p_reg, lhs.VnB(), value); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Lsl(dst.VnH(), p_reg, lhs.VnH(), value); break;
    case DataType::Type::kInt32: __ Lsl(dst.VnS(), p_reg, lhs.VnS(), value); break;
    case DataType::Type::kInt64: __ Lsl(dst.VnD(), p_reg, lhs.VnD(), value); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecShr(HVecShr* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Asr(dst.VnB(), p_reg, lhs.VnB(), value); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Asr(dst.VnH(), p_reg, lhs.VnH(), value); break;
    case DataType::Type::kInt32: __ Asr(dst.VnS(), p_reg, lhs.VnS(), value); break;
    case DataType::Type::kInt64: __ Asr(dst.VnD(), p_reg, lhs.VnD(), value); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecUShr(HVecUShr* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Lsr(dst.VnB(), p_reg, lhs.VnB(), value); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Lsr(dst.VnH(), p_reg, lhs.VnH(), value); break;
    case DataType::Type::kInt32: __ Lsr(dst.VnS(), p_reg, lhs.VnS(), value); break;
    case DataType::Type::kInt64: __ Lsr(dst.VnD(), p_reg, lhs.VnD(), value); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecSetScalars(HVecSetScalars* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kBool:
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Mov(dst.V16B(), 0, InputRegisterAt(instruction, 0)); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Mov(dst.V8H(), 0, InputRegisterAt(instruction, 0)); break;
    case DataType::Type::kInt32: __ Mov(dst.V4S(), 0, InputRegisterAt(instruction, 0)); break;
    case DataType::Type::kInt64: __ Mov(dst.V2D(), 0, InputRegisterAt(instruction, 0)); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecDotProd(HVecDotProd* instruction) {
  ...
  switch (inputs_data_size) {
    ...
    default: LOG(FATAL) << "Unsupported SIMD type size: " << inputs_data_size;
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecPredSetAll(HVecPredSetAll* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kBool:
    case DataType::Type::kUint8:
    case DataType::Type::kInt8: __ Ptrue(p_reg.VnB(), vixl::aarch64::SVE_ALL); break;
    case DataType::Type::kUint16:
    case DataType::Type::kInt16: __ Ptrue(p_reg.VnH(), vixl::aarch64::SVE_ALL); break;
    case DataType::Type::kInt32:
    case DataType::Type::kFloat32: __ Ptrue(p_reg.VnS(), vixl::aarch64::SVE_ALL); break;
    case DataType::Type::kInt64:
    case DataType::Type::kFloat64: __ Ptrue(p_reg.VnD(), vixl::aarch64::SVE_ALL); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
...
void InstructionCodeGeneratorARM64Sve::VisitVecPredWhile(HVecPredWhile* instruction) {
  ...
  switch (codegen_->GetSIMDRegisterWidth() / instruction->GetVectorLength()) {
    case 1u: __ Whilelo(LoopPReg().VnB(), left, right); break;
    case 2u: __ Whilelo(LoopPReg().VnH(), left, right); break;
    case 4u: __ Whilelo(LoopPReg().VnS(), left, right); break;
    case 8u: __ Whilelo(LoopPReg().VnD(), left, right); break;
    default: LOG(FATAL) << "Unsupported SIMD type: " << instruction->GetPackedType(); UNREACHABLE();
  }
}
