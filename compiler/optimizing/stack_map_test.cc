...
TEST(StackMapTest, Test2) {
  ...
  // First stack map.
  {
    ...
    ASSERT_EQ(2u, inline_infos.count());
    ASSERT_EQ(3u, inline_infos.at(0).GetDexPc());
    ASSERT_EQ(2u, inline_infos.at(1).GetDexPc());
    ASSERT_TRUE(inline_infos.at(0).EncodesArtMethod());
    ASSERT_TRUE(inline_infos.at(1).EncodesArtMethod());
  }
...
TEST(StackMapTest, InlineTest) {
...

  {
    ...
    ASSERT_EQ(2u, inline_infos.count());
    ASSERT_EQ(2u, inline_infos.at(0).GetDexPc());
    ASSERT_TRUE(inline_infos.at(0).EncodesArtMethod());
    ASSERT_EQ(3u, inline_infos.at(1).GetDexPc());
    ASSERT_TRUE(inline_infos.at(1).EncodesArtMethod());

    DexRegisterMap dex_registers1 = ci.GetInlineDexRegisterMapOf(sm0, inline_infos.at(0));
    ASSERT_EQ(1u, dex_registers1.size());
    ASSERT_EQ(8, dex_registers1[0].GetStackOffsetInBytes());

    DexRegisterMap dex_registers2 = ci.GetInlineDexRegisterMapOf(sm0, inline_infos.at(1));
...

  {
    ...
    ASSERT_EQ(3u, inline_infos.count());
    ASSERT_EQ(2u, inline_infos.at(0).GetDexPc());
    ASSERT_TRUE(inline_infos.at(0).EncodesArtMethod());
    ASSERT_EQ(3u, inline_infos.at(1).GetDexPc());
    ASSERT_TRUE(inline_infos.at(1).EncodesArtMethod());
    ASSERT_EQ(5u, inline_infos.at(2).GetDexPc());
    ASSERT_TRUE(inline_infos.at(2).EncodesArtMethod());

    DexRegisterMap dex_registers1 = ci.GetInlineDexRegisterMapOf(sm1, inline_infos.at(0));
    ASSERT_EQ(1u, dex_registers1.size());
    ASSERT_EQ(12, dex_registers1[0].GetStackOffsetInBytes());

    DexRegisterMap dex_registers2 = ci.GetInlineDexRegisterMapOf(sm1, inline_infos.at(1));
    ASSERT_EQ(3u, dex_registers2.size());
...

  {
    ...
    ASSERT_EQ(2u, inline_infos.at(0).GetDexPc());
    ASSERT_TRUE(inline_infos.at(0).EncodesArtMethod());
    ASSERT_EQ(5u, inline_infos.at(1).GetDexPc());
    ASSERT_TRUE(inline_infos.at(1).EncodesArtMethod());
    ASSERT_EQ(10u, inline_infos.at(2).GetDexPc());
    ASSERT_TRUE(inline_infos.at(2).EncodesArtMethod());

    DexRegisterMap dex_registers1 = ci.GetInlineDexRegisterMapOf(sm3, inline_infos.at(1));
    ASSERT_EQ(1u, dex_registers1.size());
    ASSERT_EQ(2, dex_registers1[0].GetMachineRegister());

    DexRegisterMap dex_registers2 = ci.GetInlineDexRegisterMapOf(sm3, inline_infos.at(2));
