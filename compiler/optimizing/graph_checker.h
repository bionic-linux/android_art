...
class GraphChecker : public HGraphDelegateVisitor {
 public:
  explicit GraphChecker(HGraph* graph,
    ...
    : HGraphDelegateVisitor(graph),
      ...
      uses_per_instruction_(graph->GetAllocator()->Adapter(kArenaAllocGraphChecker)),
      codegen_(codegen) {
 ...
 private:
  ...
  // of a list.
  ArenaSafeMap<int, ArenaSet<const art::HUseListNode<art::HInstruction *> *>> uses_per_instruction_;
