...
class GraphChecker : public HGraphDelegateVisitor {
 ...
 private:
  ...
  // Checks if `instruction` is its block's instruction/phi list. To do so, it actually checks
  // phis_per_block_ and instructions_per_block_ which are set versions of that. If the list to
  ...
  // in a list of Phis/Instructions.
