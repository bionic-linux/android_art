...
TEST_F(LoadStoreAnalysisTest, ArrayHeapLocations) {
  ...
  HInstruction* array_get1 = MakeArrayGet(entry, array, c1, DataType::Type::kInt32, 0);
  HInstruction* array_get2 = MakeArrayGet(entry, array, c2, DataType::Type::kInt32, 0);
  HInstruction* array_set1 = MakeArraySet(entry, array, c1, c3, DataType::Type::kInt32, 0);
  HInstruction* array_set2 = MakeArraySet(entry, array, index, c3, DataType::Type::kInt32, 0);
...
TEST_F(LoadStoreAnalysisTest, ArrayIndexAliasingTest) {
  ...
  HInstruction* add0 = MakeAdd(body, DataType::Type::kInt32, index, c0);
  HInstruction* add1 = MakeAdd(body, DataType::Type::kInt32, index, c1);
  HInstruction* sub0 = MakeSub(body, DataType::Type::kInt32, index, c0);
  HInstruction* sub1 = MakeSub(body, DataType::Type::kInt32, index, c1);
  HInstruction* sub_neg1 = MakeSub(body, DataType::Type::kInt32, index, c_neg1);
  HInstruction* rev_sub1 = MakeSub(body, DataType::Type::kInt32, c1, index);
  // array[0] = c0
  HInstruction* arr_set1 = MakeArraySet(body, array, c0, c0, DataType::Type::kInt32, 0);
  // array[1] = c0
  HInstruction* arr_set2 = MakeArraySet(body, array, c1, c0, DataType::Type::kInt32, 0);
  // array[i+0] = c0
  HInstruction* arr_set3 = MakeArraySet(body, array, add0, c0, DataType::Type::kInt32, 0);
  // array[i+1] = c0
  HInstruction* arr_set4 = MakeArraySet(body, array, add1, c0, DataType::Type::kInt32, 0);
  // array[i-0] = c0
  HInstruction* arr_set5 = MakeArraySet(body, array, sub0, c0, DataType::Type::kInt32, 0);
  // array[i-1] = c0
  HInstruction* arr_set6 = MakeArraySet(body, array, sub1, c0, DataType::Type::kInt32, 0);
  // array[1-i] = c0
  HInstruction* arr_set7 = MakeArraySet(body, array, rev_sub1, c0, DataType::Type::kInt32, 0);
  // array[i-(-1)] = c0
  HInstruction* arr_set8 = MakeArraySet(body, array, sub_neg1, c0, DataType::Type::kInt32, 0);
...
TEST_F(LoadStoreAnalysisTest, ArrayAliasingTest) {
  ...
  HInstruction* i_add6 = MakeAdd(entry, DataType::Type::kInt32, index, c6);
  HInstruction* i_add8 = MakeAdd(entry, DataType::Type::kInt32, index, c8);
...
TEST_F(LoadStoreAnalysisTest, ArrayIndexCalculationOverflowTest) {
  ...
  HInstruction* add_0x80000000 = MakeAdd(entry, DataType::Type::kInt32, index, c_0x80000000);
  HInstruction* sub_0x80000000 = MakeSub(entry, DataType::Type::kInt32, index, c_0x80000000);
  HInstruction* arr_set_1 =
      MakeArraySet(entry, array, add_0x80000000, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_2 =
      MakeArraySet(entry, array, sub_0x80000000, c0, DataType::Type::kInt32, 0);

  // `index+0x10` and `index-0xFFFFFFF0` array indices MAY alias.
  HInstruction* add_0x10 = MakeAdd(entry, DataType::Type::kInt32, index, c_0x10);
  HInstruction* sub_0xFFFFFFF0 = MakeSub(entry, DataType::Type::kInt32, index, c_0xFFFFFFF0);
  HInstruction* arr_set_3 = MakeArraySet(entry, array, add_0x10, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_4 =
      MakeArraySet(entry, array, sub_0xFFFFFFF0, c0, DataType::Type::kInt32, 0);

  // `index+0x7FFFFFFF` and `index-0x80000001` array indices MAY alias.
  HInstruction* add_0x7FFFFFFF = MakeAdd(entry, DataType::Type::kInt32, index, c_0x7FFFFFFF);
  HInstruction* sub_0x80000001 = MakeSub(entry, DataType::Type::kInt32, index, c_0x80000001);
  HInstruction* arr_set_5 =
      MakeArraySet(entry, array, add_0x7FFFFFFF, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_6 =
      MakeArraySet(entry, array, sub_0x80000001, c0, DataType::Type::kInt32, 0);

  // `index+0` and `index-0` array indices MAY alias.
  HInstruction* add_0 = MakeAdd(entry, DataType::Type::kInt32, index, c0);
  HInstruction* sub_0 = MakeSub(entry, DataType::Type::kInt32, index, c0);
  HInstruction* arr_set_7 = MakeArraySet(entry, array, add_0, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_8 = MakeArraySet(entry, array, sub_0, c0, DataType::Type::kInt32, 0);
