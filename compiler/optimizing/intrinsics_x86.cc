  ...
  switch (type) {
    ...
    case DataType::Type::kInt64: {
        ...
        if (is_volatile) {
          ...
          __ movl(output_hi, address_offset);
        }
      }
      break;
...
void IntrinsicLocationsBuilderX86::VisitUnsafeGetLongAbsolute(HInvoke* invoke) {
...
void IntrinsicLocationsBuilderX86::VisitUnsafeGetByteAbsolute(HInvoke* invoke) {
...
void IntrinsicCodeGeneratorX86::VisitUnsafeGetLongAbsolute(HInvoke* invoke) {
  VisitJdkUnsafeGetLongAbsolute(invoke);
}
...
void IntrinsicCodeGeneratorX86::VisitUnsafeGetByteAbsolute(HInvoke* invoke) {
  VisitJdkUnsafeGetByteAbsolute(invoke);
}
...
void IntrinsicLocationsBuilderX86::VisitJdkUnsafeGetLongAbsolute(HInvoke* invoke) {
  CreateIntIntToIntLocations(
...
void IntrinsicLocationsBuilderX86::VisitJdkUnsafeGetByteAbsolute(HInvoke* invoke) {
  CreateIntIntToIntLocations(
      allocator_, invoke, codegen_, DataType::Type::kInt8, /*is_volatile=*/ false);
}
...
void IntrinsicCodeGeneratorX86::VisitJdkUnsafeGetLongAbsolute(HInvoke* invoke) {
...
void IntrinsicCodeGeneratorX86::VisitJdkUnsafeGetByteAbsolute(HInvoke* invoke) {
