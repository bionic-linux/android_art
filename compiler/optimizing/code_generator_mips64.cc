...
void InstructionCodeGeneratorMIPS64::GenerateMinMax(
    LocationSummary* locations,
    bool is_min,
    // FIXME: the original code handled int/long similary, that cannot be right?
...
void InstructionCodeGeneratorMIPS64::GenerateMinMaxFP(
