...
void LocationsBuilderX86_64::HandleFieldSet(HInstruction* instruction,
  ...
  bool check_gc_card = codegen_->ShouldCheckGCCardEliminatedWriteBarriers(
...
void InstructionCodeGeneratorX86_64::HandleFieldSet(HInstruction* instruction,
  ...
  } else if (codegen_->ShouldCheckGCCardEliminatedWriteBarriers(
  ...
  switch (value_type) {
    ...
    case DataType::Type::kReference: {
      ...
      const bool check_for_eliminated_write_barriers =
          codegen_->ShouldCheckGCCardEliminatedWriteBarriers(
              value_type, instruction->GetValue(), write_barrier_kind);
      ...
      const bool check_for_maybe_skipped_write_barriers =
          codegen_->CanCheckGCCard() && skip_marking_gc_card;
