...
TEST_F(ConstantFoldingTest, UnsignedComparisonsWithZero) {
  ...
  HInstruction* last;
  last = MakeCondition(block, kCondA, zero, parameter);
  MakeSelect(block, last, parameter, parameter);
  last = MakeCondition(block, kCondA, parameter, zero);
  MakeSelect(block, last, parameter, parameter);
  last = MakeCondition(block, kCondAE, zero, parameter);
  MakeSelect(block, last, parameter, parameter);
  last = MakeCondition(block, kCondAE, parameter, zero);
  MakeSelect(block, last, parameter, parameter);
  last = MakeCondition(block, kCondB, zero, parameter);
  MakeSelect(block, last, parameter, parameter);
  last = MakeCondition(block, kCondB, parameter, zero);
  MakeSelect(block, last, parameter, parameter);
  last = MakeCondition(block, kCondBE, zero, parameter);
  MakeSelect(block, last, parameter, parameter);
  last = MakeCondition(block, kCondBE, parameter, zero);
  MakeSelect(block, last, parameter, parameter);
