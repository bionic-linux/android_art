...
class HInstanceFieldSet final : public HExpression<2> {
 public:
  ...
  void SetIgnoreWriteBarrier(bool value = true) { SetPackedFlag<kFlagIgnoreWriteBarrier>(value); }
 ...
 private:
  ...
  static constexpr size_t kNumberOfInstanceFieldSetPackedBits = kFlagIgnoreWriteBarrier + 1;
...
class HArraySet final : public HExpression<3> {
 ...
 private:
  ...
  static constexpr size_t kNumberOfArraySetPackedBits = kFlagIgnoreWriteBarrier + 1;
...
class HStaticFieldSet final : public HExpression<2> {
 ...
 private:
  ...
  static constexpr size_t kNumberOfStaticFieldSetPackedBits = kFlagIgnoreWriteBarrier + 1;
