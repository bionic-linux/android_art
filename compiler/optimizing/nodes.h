...
class HInvoke : public HVariableInputSizeInstruction {
 public:
  ...
  void SetIsControlFlow(bool is_control_flow) { SetPackedFlag<kFlagIsControlFlow>(is_control_flow); }

  bool IsControlFlow() const OVERRIDE { return GetPackedFlag<kFlagIsControlFlow>(); }
 ...
 protected:
  ...
  static constexpr size_t kFlagIsControlFlow = kFlagAlwaysThrows + 1;
  static constexpr size_t kNumberOfInvokePackedBits = kFlagIsControlFlow + 1;
