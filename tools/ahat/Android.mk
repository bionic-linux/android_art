...
AHAT_TEST_DUMP_HPROF_DATA := $(intermediates.COMMON)/android_data-test-dump.hprof
AHAT_TEST_DUMP_BASE_HPROF := $(intermediates.COMMON)/test-dump-base.hprof
AHAT_TEST_DUMP_BASE_HPROF_DATA := $(intermediates.COMMON)/android_data-test-dump-base.hprof
...
$(AHAT_TEST_DUMP_HPROF): PRIVATE_AHAT_TEST_DATA := $(AHAT_TEST_DUMP_HPROF_DATA)
$(AHAT_TEST_DUMP_HPROF): $(AHAT_TEST_DUMP_JAR) $(AHAT_TEST_DUMP_DEPENDENCIES)
	rm -rf $(PRIVATE_AHAT_TEST_DATA)
	mkdir -p $(PRIVATE_AHAT_TEST_DATA)
	ANDROID_DATA=$(PRIVATE_AHAT_TEST_DATA) \
...
$(AHAT_TEST_DUMP_BASE_HPROF): PRIVATE_AHAT_TEST_DATA := $(AHAT_TEST_DUMP_BASE_HPROF_DATA)
