...
public class SiteTest {
  ...
  public void objectsAllocatedAtKnownSites() throws IOException {
    ...
    assertEquals(34, sKnownSite.getLineNumber());
    ...
    assertEquals(42, sKnownSubSite.getLineNumber());
    ...
    assertEquals(35, sKnownSubSiteParent.getLineNumber());
    ...
    assertEquals(50, sKnownSiteParent.getLineNumber());
    ...
    assertEquals(46, sOverriddenSite.getLineNumber());
