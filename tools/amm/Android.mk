...
AMM_DEBUG_JAR := $(LOCAL_BUILT_MODULE)
...
LOCAL_JAVA_RESOURCE_FILES := $(LOCAL_PATH)/test/aahat.png
...
amm-test: PRIVATE_AMM_DEBUG_JAR := $(AMM_DEBUG_JAR)
amm-test: $(AMM_TEST_APK) $(AMM_DEBUG_JAR)
	...
	adb shell am start -W com.android.amm.test/com.android.amm.test.MainActivity
	java -jar $(PRIVATE_AMM_DEBUG_JAR) -s $$(adb shell pgrep amm.test)
