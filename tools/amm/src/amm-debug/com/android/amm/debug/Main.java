...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (ammType == 0 || snapshotType == 0) {
      ...
      jdwp.invokeMethod(inMemoryLoader,
                        thread,
                        inMemoryLoaderType,
                        loadClassMethod,
                        ammClassNameStringId);
    ...
    long getStandardMetricMethod = jdwp.methodByName(ammType,
                                                     "getStandardMetric",
                                                     "()Lcom/android/amm/ActionableMemoryMetric;");
   ...
   */
  private static byte[] getAmmDexBytes() throws IOException {
