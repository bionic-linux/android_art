...
for i in $all_tests; do
  echo $i
  ${ADB} shell "chroot $ART_TEST_CHROOT env LD_LIBRARY_PATH= ANDROID_ROOT='/system' ANDROID_RUNTIME_ROOT='/system/etc/runtime_module' ANDROID_TZDATA_ROOT='/system' $i" || fail $i
done
