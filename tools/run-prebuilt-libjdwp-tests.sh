...
echo running command: LD_LIBRARY_PATH=\"$(dirname $jdwp_path):$LD_LIBRARY_PATH\" ./art/tools/run-jdwp-tests.sh \
  $args \
  -Xplugin:$plugin \
...
LD_LIBRARY_PATH="$(dirname $jdwp_path):$LD_LIBRARY_PATH" ./art/tools/run-jdwp-tests.sh \
  $args                                                                                \
  -Xplugin:$plugin                                                                     \
  --agent-wrapper ${wrapper}=${props_path}                                             \
  --jdwp-path $jdwp_path                                                               \
