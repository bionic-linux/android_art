...
static void NativeMethods_benchmarkLocalRefsBaseline(JNIEnv*, jclass, jobject) {
}
static constexpr size_t kRepetitions = 100;
static void NativeMethods_benchmarkAddLocalRef(JNIEnv* env, jclass, jobject obj) {
  for (size_t i = 0; i != kRepetitions; ++i) {
    env->NewLocalRef(obj);
  }
  // Leak the local references, they will be freed automatically.
}
static void NativeMethods_benchmarkAddRemoveLocalRef(JNIEnv* env, jclass, jobject obj) {
  for (size_t i = 0; i != kRepetitions; ++i) {
    jobject local = env->NewLocalRef(obj);
    env->DeleteLocalRef(local);
  }
}
static void NativeMethods_benchmarkAddRemoveLocalRefsStack(JNIEnv* env, jclass, jobject obj) {
...
static void NativeMethods_benchmarkAddAddRemoveAddLocalRefs(JNIEnv* env, jclass, jobject obj) {
  for (size_t i = 0; i != kRepetitions; ++i) {
...
static void NativeMethods_benchmarkPushAndPopFrameLocalRefs(JNIEnv* env, jclass, jobject obj) {
  struct Recurse {
...
static JNINativeMethod gMethods_Locals[] = {
  NATIVE_METHOD(NativeMethods, benchmarkLocalRefsBaseline, "(Ljava/lang/Object;)V"),
  NATIVE_METHOD(NativeMethods, benchmarkAddLocalRef, "(Ljava/lang/Object;)V"),
  NATIVE_METHOD(NativeMethods, benchmarkAddRemoveLocalRef, "(Ljava/lang/Object;)V"),
  NATIVE_METHOD(NativeMethods, benchmarkAddRemoveLocalRefsStack, "(Ljava/lang/Object;)V"),
  NATIVE_METHOD(NativeMethods, benchmarkAddAddRemoveAddLocalRefs, "(Ljava/lang/Object;)V"),
  NATIVE_METHOD(NativeMethods, benchmarkPushAndPopFrameLocalRefs, "(Ljava/lang/Object;)V"),
};
