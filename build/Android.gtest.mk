...
$(ART_TEST_HOST_GTEST_MainUncompressed_DEX): $(ART_TEST_HOST_GTEST_Main_DEX)
	cp $< $@
	$(call uncompress-dexs, $@)
	$(call align-package, $@)

$(ART_TEST_TARGET_GTEST_MainUncompressed_DEX): $(ART_TEST_TARGET_GTEST_Main_DEX)
	$(copy-and-uncompress-dexs,$<,$@)
