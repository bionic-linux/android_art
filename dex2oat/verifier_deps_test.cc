...
TEST_F(VerifierDepsTest, StringToId) {
  ...
  ASSERT_STREQ("LMain;", verifier_deps_->GetStringFromId(*primary_dex_file_, id_Main1));
  ...
  ASSERT_STREQ("LMain;", verifier_deps_->GetStringFromId(*primary_dex_file_, id_Main2));
  ...
  ASSERT_STREQ("Lorem ipsum", verifier_deps_->GetStringFromId(*primary_dex_file_, id_Lorem1));
  ...
  ASSERT_STREQ("Lorem ipsum", verifier_deps_->GetStringFromId(*primary_dex_file_, id_Lorem2));
