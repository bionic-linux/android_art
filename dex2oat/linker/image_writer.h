...
class ImageWriter FINAL {
 ...
 private:
  ...
  void DoCopyReference(DestType* dest, ObjPtr<mirror::Object> src, size_t oat_index)
      REQUIRES_SHARED(Locks::mutator_lock_);
  void CopyReference(mirror::HeapReference<mirror::Object>* dest,
                     ObjPtr<mirror::Object> src,
                     size_t oat_index)
      REQUIRES_SHARED(Locks::mutator_lock_);
  void CopyReference(mirror::CompressedReference<mirror::Object>* dest,
                     ObjPtr<mirror::Object> src,
                     size_t oat_index)
      REQUIRES_SHARED(Locks::mutator_lock_);
  // CopyReference() overload that does not record image relocations.
