...
void ImageWriter::FixupPointerArray(mirror::Object* dst,
  ...
  CopyAndRecordReference(dst->GetFieldObjectReferenceAddr<kVerifyNone>(Class::ClassOffset()),
                         arr->GetClass(),
                         oat_index);
...
class ImageWriter::FixupVisitor {
 public:
  ...
  void operator()(ObjPtr<Object> obj, MemberOffset offset, bool is_static ATTRIBUTE_UNUSED) const
    ...
    image_writer_->CopyAndRecordReference(
...
void ImageWriter::FixupDexCacheArrayEntry(GcRoot<mirror::CallSite>* orig_array,
                                          ...
                                          uint32_t array_index,
                                          size_t oat_index) {
  CopyAndRecordReference(new_array[array_index].AddressWithoutBarrier(),
...
void ImageWriter::CopyAndFixupMethod(ArtMethod* orig,
  ...
  CopyAndRecordReference(copy->GetDeclaringClassAddressWithoutBarrier(),
...
void ImageWriter::CopyAndRecordReference(DestType* dest,
