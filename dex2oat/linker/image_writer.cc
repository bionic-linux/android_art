...
void ImageWriter::CopyReference(mirror::CompressedReference<mirror::Object>* dest,
                                ObjPtr<mirror::Object> src) {
  // This overload is used when we do not have the address for recording the relocation, namely
  // for interned string and the class table. The relocation needs to be recorded some other way.
  dest->Assign(GetImageAddress(src.Ptr()));
}
