...
bool OatWriter::FinishVdexFile(File* vdex_file, verifier::VerifierDeps* verifier_deps) {
  ...
  if (extract_dex_files_into_vdex_) {
    new (ptr) VdexFile::VdexSectionHeader(VdexSection::kDexFileSection,
                                          vdex_dex_files_offset_,
                                          vdex_verifier_deps_offset_ - vdex_dex_files_offset_);
  } else {
    new (ptr) VdexFile::VdexSectionHeader(VdexSection::kDexFileSection, 0u, 0u);
  }
  ptr += sizeof(VdexFile::VdexFileHeader);
