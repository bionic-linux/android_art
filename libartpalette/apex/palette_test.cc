...
<<<<<<< TARGET BRANCH (ab6812 art: disable standalone cts tests for native-bridge am: debd)
...
>>>>>>> SOURCE BRANCH (792482 Avoid dynamic lib dependencies on internal ART libraries in )
