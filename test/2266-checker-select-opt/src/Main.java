...
public class Main {
    ...
    // If a == b returns b (which is equal to a) else returns a. This can be simplified to just return a.
    ...
    // If a != b returns b else returns a (which is equal to b). This can be simplified to just return b.
