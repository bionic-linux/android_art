...
public class Main {
  ...
  /// CHECK-START-ARM64: int Main.testAllocationEliminationOfArray2() load_store_elimination (before)
  /// CHECK: NewArray
  /// CHECK: ArraySet
  /// CHECK: ArraySet
  /// CHECK: ArrayGet

  /// CHECK-START-ARM64: int Main.testAllocationEliminationOfArray2() load_store_elimination (after)
  /// CHECK-NOT: NewArray
  /// CHECK-NOT: ArraySet
  /// CHECK-NOT: ArraySet
  /// CHECK-NOT: ArrayGet
