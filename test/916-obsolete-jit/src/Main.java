...
public class Main {
  ...
  public static void doTest(Transform t) {
    ...
    do {
      ...
      t.sayHi(() -> {
        // 2 so that we check if 'sayHi' is being interpreted.
        interpreting = Main.isInterpretedAt(2);
      });
      j++;
  ...
  private static native boolean isInterpretedAt(int depth_up);
