...
public class Main {
  ...
  /// CHECK-START: int Main.ror_int_constant_c_negc(int) instruction_simplifier$after_fold (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  ...
  /// CHECK-START: int Main.ror_int_constant_c_negc(int) instruction_simplifier$after_fold (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  /// CHECK:          <<Ror:i\d+>>          Ror [<<ArgValue>>,<<Const2>>]
  /// CHECK:                                Return [<<Ror>>]
