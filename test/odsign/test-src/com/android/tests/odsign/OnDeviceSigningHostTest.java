...
public class OnDeviceSigningHostTest extends BaseHostJUnit4Test {
    ...
    public void verifyGeneratedArtifactsLoaded() throws Exception {
        // This test checks both zygote and system_server processes to see that they have
        // loaded the artifacts compiled and signed by odrefresh and odsign. There is one combined
        // test because the device reboots between each @Test method and that's time consuming.
