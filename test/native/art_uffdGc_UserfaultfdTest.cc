...
extern "C" JNIEXPORT void JNICALL Java_art_uffdGc_UserfaultfdTest_setUpUserfaultfd(JNIEnv*) {
...
extern "C"
JNIEXPORT jint JNICALL Java_art_uffdGc_UserfaultfdTest_performKernelSpaceUserfault(JNIEnv*) {
  if (!perform_tests) {
    return 0;
  }
...
extern "C" JNIEXPORT jint JNICALL Java_art_uffdGc_UserfaultfdTest_uffdWithoutUserModeOnly(JNIEnv*) {
  if (!perform_tests) {
    return 0;
  }
...
extern "C" JNIEXPORT jint JNICALL Java_art_uffdGc_UserfaultfdTest_performMremapDontUnmap(JNIEnv*) {
  int ret = 0;
  if (!perform_tests) {
    return 0;
  }
...
extern "C" JNIEXPORT jint JNICALL Java_art_uffdGc_UserfaultfdTest_performMinorUffd(JNIEnv*) {
  int ret = 0;
  if (!perform_tests) {
    return 0;
  }
