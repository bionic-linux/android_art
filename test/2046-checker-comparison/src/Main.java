...
public class Main {
    ...
    /// CHECK: <<LessThanOrEqual:z\d+>> LessThanOrEqual
    /// CHECK: <<BNot:z\d+>>            BooleanNot [<<LessThanOrEqual>>]
    /// CHECK:                          Return [<<BNot>>]
    ...
    /// CHECK: <<GreaterThanOrEqual:z\d+>> GreaterThanOrEqual
    /// CHECK: <<BNot:z\d+>>               BooleanNot [<<GreaterThanOrEqual>>]
    /// CHECK:                             Return [<<BNot>>]
