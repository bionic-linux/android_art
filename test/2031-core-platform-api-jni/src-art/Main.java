...
public class Main {
  ...
  private static final MethodHandle ART_MODULE_LOAD_HOOK =
      getLoadLibraryHook("treatAsNativeCorePlatform");

  private static final String DEX_PARENT =
      new File(System.getenv("DEX_LOCATION"), "2031-core-platform-api-jni.jar").getAbsolutePath();
  ...
  private static final String DEX_CHILD =
      new File(System.getenv("DEX_LOCATION"), "2031-core-platform-api-jni-ex.jar").getAbsolutePath();
  ...
  public static native void treatAsNativeCorePlatform(String library);
