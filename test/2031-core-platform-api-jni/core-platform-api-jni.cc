...
extern "C" JNIEXPORT void JNICALL Java_Main_treatAsNativeCorePlatform(JNIEnv* env,
                                                                      jclass /*klass*/,
                                                                      jstring library_name) {
  InstallLibraryPathClassifier(env,
                               library_name,
                               art::hiddenapi::SharedObjectKind::kNativeCorePlatform);
}
