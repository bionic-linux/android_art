...
public class Main {
  ...
  /// CHECK-START: boolean Main.$noinline$EqualBoolVsIntConst(boolean) instruction_simplifier$after_fold (before)
  ...
  /// CHECK-START: boolean Main.$noinline$EqualBoolVsIntConst(boolean) instruction_simplifier$after_fold (after)
  ...
  /// CHECK-START: boolean Main.$noinline$NotEqualBoolVsIntConst(boolean) instruction_simplifier$after_fold (before)
  /// CHECK-DAG:     <<Arg:z\d+>>      ParameterValue
  /// CHECK-DAG:     <<Const0:i\d+>>   IntConstant 0
  /// CHECK-DAG:     <<Const1:i\d+>>   IntConstant 1
  /// CHECK-DAG:     <<Const2:i\d+>>   IntConstant 2
  ...
  /// CHECK-START: boolean Main.$noinline$NotEqualBoolVsIntConst(boolean) instruction_simplifier$after_fold (after)
  ...
  /// CHECK-START: boolean Main.$noinline$NotNotBool(boolean) instruction_simplifier$after_fold (before)
  /// CHECK-DAG:     <<Arg:z\d+>>       ParameterValue
  /// CHECK-DAG:     <<NotArg:z\d+>>    BooleanNot [<<Arg>>]
  /// CHECK-DAG:     <<NotNotArg:z\d+>> BooleanNot [<<NotArg>>]
  /// CHECK-DAG:                        Return [<<NotNotArg>>]

  /// CHECK-START: boolean Main.$noinline$NotNotBool(boolean) instruction_simplifier$after_fold (after)
  /// CHECK-DAG:     <<Arg:z\d+>>       ParameterValue
  /// CHECK-DAG:     <<NotArg:z\d+>>    BooleanNot [<<Arg>>]
  /// CHECK-DAG:                        Return [<<Arg>>]
  ...
  /// CHECK-START: int Main.$noinline$booleanFieldNotEqualOne() instruction_simplifier$after_fold (before)
  /// CHECK-DAG:      <<Const1:i\d+>>   IntConstant 1
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  ...
  /// CHECK-START: int Main.$noinline$booleanFieldNotEqualOne() instruction_simplifier$after_fold (after)
  /// CHECK-DAG:      <<doThrow:z\d+>>  StaticFieldGet
  /// CHECK-DAG:      <<Field:z\d+>>    StaticFieldGet
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  /// CHECK-DAG:      <<Const54:i\d+>>  IntConstant 54
  ...
  /// CHECK-START: int Main.$noinline$booleanFieldEqualZero() instruction_simplifier$after_fold (before)
  /// CHECK-DAG:      <<Const0:i\d+>>   IntConstant 0
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  /// CHECK-DAG:      <<Const54:i\d+>>  IntConstant 54
  /// CHECK-DAG:      <<doThrow:z\d+>>  StaticFieldGet
  ...
  /// CHECK-START: int Main.$noinline$booleanFieldEqualZero() instruction_simplifier$after_fold (after)
  /// CHECK-DAG:      <<doThrow:z\d+>>  StaticFieldGet
  /// CHECK-DAG:      <<Field:z\d+>>    StaticFieldGet
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  /// CHECK-DAG:      <<Const54:i\d+>>  IntConstant 54
  ...
  /// CHECK-START: int Main.$noinline$intConditionNotEqualOne(int) instruction_simplifier$after_fold (before)
  /// CHECK-DAG:      <<Arg:i\d+>>      ParameterValue
  /// CHECK-DAG:      <<Const0:i\d+>>   IntConstant 0
  /// CHECK-DAG:      <<Const1:i\d+>>   IntConstant 1
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  ...
  /// CHECK-START: int Main.$noinline$intConditionNotEqualOne(int) instruction_simplifier$after_fold (after)
  /// CHECK-DAG:      <<Arg:i\d+>>      ParameterValue
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  /// CHECK-DAG:      <<Const42:i\d+>>  IntConstant 42
  /// CHECK-DAG:      <<Const54:i\d+>>  IntConstant 54
  ...
  /// CHECK-START: int Main.$noinline$intConditionEqualZero(int) instruction_simplifier$after_fold (before)
  /// CHECK-DAG:      <<Arg:i\d+>>      ParameterValue
  /// CHECK-DAG:      <<Const0:i\d+>>   IntConstant 0
  /// CHECK-DAG:      <<Const1:i\d+>>   IntConstant 1
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  ...
  /// CHECK-START: int Main.$noinline$intConditionEqualZero(int) instruction_simplifier$after_fold (after)
  /// CHECK-DAG:      <<Arg:i\d+>>      ParameterValue
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  /// CHECK-DAG:      <<Const42:i\d+>>  IntConstant 42
  /// CHECK-DAG:      <<Const54:i\d+>>  IntConstant 54
