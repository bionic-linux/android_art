...
public class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        class LocalClassWithCaptureAlternateOrdering {
            private final String argumentValue;
            private final long capturedValue;

            LocalClassWithCaptureAlternateOrdering(@AnnotationA String p1) {
                this.argumentValue = p1;
                this.capturedValue = CAPTURED_VALUE;
            }
        }
        ...
        DumpConstructorParameterAnnotations(LocalClassWithCapture.class);
        DumpConstructorParameterAnnotations(LocalClassWithCaptureAlternateOrdering.class);
        Main m = new Main();
