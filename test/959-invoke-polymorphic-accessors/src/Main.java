...
public class Main {
    ...
    public static class Tester {
        ...
        public static void assertEqual(char actual, char expected) {
            if (actual != expected) {
                throw new AssertionError("Actual != Expected (" + actual + " != " + expected + ")");
            }
        }
    ...
    public static class InvokeExactTester extends Tester {
        ...
        static void setByte(MethodHandle m, ValueHolder v, byte value, boolean expectFailure)
            ...
            assertEqual(exceptionThrown, expectFailure);
        }
    ...
    public static class UnreflectTester extends Tester {
        public static void main() throws Throwable {
            ValueHolder v = new ValueHolder();
            {
                ...
                assertEqual((char)MethodHandles.lookup().unreflectGetter(f).invokeExact(v), 'z');
                MethodHandles.lookup().unreflectSetter(f).invokeExact(v, 'A');
                assertEqual((char)MethodHandles.lookup().unreflectGetter(f).invokeExact(v), 'A');
            }
            {
                ...
                assertEqual((int)MethodHandles.lookup().unreflectGetter(f).invokeExact(),
                            newValue);
            ...
            }
            {
                ...
                assertEqual((boolean)MethodHandles.lookup().unreflectGetter(f).invokeExact(v),
                            true);
            ...
            }
            {
                ...
                assertEqual((boolean)MethodHandles.lookup().unreflectGetter(f).invokeExact(),
                            false);
