...
public class Main {
  ...
  public static void test_Integer_doubleUnsignedCompare() {
    ...
    private static long $inline$hidden_longzero() {
    return (long)("1".indexOf('1'));
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareLong_B(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$BelowLong((long)cmp, $inline$hidden_longzero());
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareLong_BE(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$BelowOrEqualLong((long)cmp, $inline$hidden_longzero());
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareLong_A(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$AboveLong((long)cmp, $inline$hidden_longzero());
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareLong_AE(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$AboveOrEqualLong((long)cmp, $inline$hidden_longzero());
  }

  public static void test_Long_doubleUnsignedCompare() {
    // <
    assertEquals($noinline$testDoubleUnsignedCompareLong_B(0L, 0L), false);
    assertEquals($noinline$testDoubleUnsignedCompareLong_B(Long.MIN_VALUE, 0L), false);
    assertEquals($noinline$testDoubleUnsignedCompareLong_B(0L, Long.MIN_VALUE), false);
    ...
    // >
    assertEquals($noinline$testDoubleUnsignedCompareLong_A(0L, 0L), false);
    assertEquals($noinline$testDoubleUnsignedCompareLong_A(Long.MIN_VALUE, 0L), true);
    assertEquals($noinline$testDoubleUnsignedCompareLong_A(0L, Long.MIN_VALUE), true);
