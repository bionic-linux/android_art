...
public class Main {
    ...
    private static void $noinline$testHighestOneBitLong() {
        ...
        // heuristics.
        $noinline$testHighestOneBitLongFirst32();
        $noinline$testHighestOneBitLongLast32();
    }

    /// CHECK-START: void Main.$noinline$testHighestOneBitLongFirst32() constant_folding (before)
    /// CHECK-DAG: InvokeStaticOrDirect intrinsic:LongHighestOneBit

    /// CHECK-START: void Main.$noinline$testHighestOneBitLongFirst32() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect intrinsic:LongHighestOneBit
    private static void $noinline$testHighestOneBitLongFirst32() {
    ...
    /// CHECK-START: void Main.$noinline$testHighestOneBitLongLast32() constant_folding (before)
    /// CHECK-DAG: InvokeStaticOrDirect intrinsic:LongHighestOneBit

    /// CHECK-START: void Main.$noinline$testHighestOneBitLongLast32() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect intrinsic:LongHighestOneBit
    private static void $noinline$testHighestOneBitLongLast32() {
    ...
    private static void $noinline$testLowestOneBitLong() {
        ...
        // We need to do two smaller methods because otherwise we don't compile it due to our
        // heuristics.
        $noinline$testLowestOneBitLongFirst32();
        $noinline$testLowestOneBitLongLast32();
    }

    /// CHECK-START: void Main.$noinline$testLowestOneBitLongFirst32() constant_folding (before)
    /// CHECK-DAG: InvokeStaticOrDirect intrinsic:LongLowestOneBit

    /// CHECK-START: void Main.$noinline$testLowestOneBitLongFirst32() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect intrinsic:LongLowestOneBit
    private static void $noinline$testLowestOneBitLongFirst32() {
    ...
    /// CHECK-START: void Main.$noinline$testLowestOneBitLongLast32() constant_folding (before)
    /// CHECK-DAG: InvokeStaticOrDirect intrinsic:LongLowestOneBit

    /// CHECK-START: void Main.$noinline$testLowestOneBitLongLast32() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect intrinsic:LongLowestOneBit
    private static void $noinline$testLowestOneBitLongLast32() {
    ...
    private static void $noinline$testLeadingZerosLong() {
        $noinline$assertLongEquals(1, Long.numberOfLeadingZeros(Long.MAX_VALUE));
        $noinline$assertLongEquals(0, Long.numberOfLeadingZeros(Long.MIN_VALUE));
        // We need to do two smaller methods because otherwise we don't compile it due to our
        // heuristics.
    ...
    private static void $noinline$testTrailingZerosLong() {
        $noinline$assertLongEquals(0, Long.numberOfTrailingZeros(Long.MAX_VALUE));
        $noinline$assertLongEquals(63, Long.numberOfTrailingZeros(Long.MIN_VALUE));
        // We need to do two smaller methods because otherwise we don't compile it due to our
        // heuristics.
