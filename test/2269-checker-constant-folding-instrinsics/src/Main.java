...
public class Main {
    ...
    /// CHECK-DAG: InvokeStaticOrDirect method_name:java.lang.Integer.numberOfLeadingZeros

    /// CHECK-START: void Main.$noinline$testLeadingZerosInt() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect method_name:java.lang.Integer.numberOfLeadingZeros
    ...
    private static void $noinline$testLeadingZerosLong() {
        // TODO(solanes): Somehow the graph builder breaks if I try to call the full 64 lines here.
    ...
    /// CHECK-DAG: InvokeStaticOrDirect method_name:java.lang.Long.numberOfLeadingZeros

    /// CHECK-START: void Main.$noinline$testLeadingZerosLongFirst32() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect method_name:java.lang.Long.numberOfLeadingZeros
    ...
    /// CHECK-DAG: InvokeStaticOrDirect method_name:java.lang.Integer.numberOfTrailingZeros

    /// CHECK-START: void Main.$noinline$testTrailingZerosInt() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect method_name:java.lang.Integer.numberOfTrailingZeros
    ...
    /// CHECK-DAG: InvokeStaticOrDirect method_name:java.lang.Long.numberOfTrailingZeros

    /// CHECK-START: void Main.$noinline$testTrailingZerosLongFirst32() constant_folding (after)
    /// CHECK-NOT: InvokeStaticOrDirect method_name:java.lang.Long.numberOfTrailingZeros
