...
public class Main {
  public static void main(String[] args) throws Error {
    ...
    // Several sets, multiple receivers. (set obj1, obj2, obj1 and see that the card of obj1 gets
    // eliminated)
    ...
    $noinline$testInstanceFieldSetsBlocked(new Main(), new Object(), new Object(), new Object());
  ...
  /// CHECK: InstanceFieldSet field_name:Main.inner field_type:Reference ignore_write_barrier:false
  /// CHECK: InstanceFieldSet field_name:Main.inner2 field_type:Reference ignore_write_barrier:true
  /// CHECK: InstanceFieldSet field_name:Main.inner3 field_type:Reference ignore_write_barrier:true
  ...
  /// CHECK: StaticFieldSet field_name:Main.inner_static field_type:Reference ignore_write_barrier:false
  /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference ignore_write_barrier:true
  /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference ignore_write_barrier:true
  ...
  /// CHECK: InstanceFieldSet field_name:Main.inner field_type:Reference ignore_write_barrier:false
  /// CHECK: InstanceFieldSet field_name:Main.inner2 field_type:Reference ignore_write_barrier:false
  /// CHECK: InstanceFieldSet field_name:Main.inner3 field_type:Reference ignore_write_barrier:false
  ...
  /// CHECK: StaticFieldSet field_name:Main.inner_static field_type:Reference ignore_write_barrier:false
  /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference ignore_write_barrier:false
  /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference ignore_write_barrier:false
  ...
  /// CHECK: InstanceFieldSet field_name:MultipleObject.inner field_type:Reference ignore_write_barrier:false
  /// CHECK: InstanceFieldSet field_name:MultipleObject.inner field_type:Reference ignore_write_barrier:false
  /// CHECK: InstanceFieldSet field_name:MultipleObject.inner2 field_type:Reference ignore_write_barrier:true
  ...
  private static Main $noinline$testInstanceFieldSetsMultipleReceivers(
    ...
    m.mo.inner = o;
    // This card table for `m.mo2` can't me removed. Note that in `m.mo2 = new MultipleObject();`
    // above the receiver is `m`, not `m.mo2.
    m.mo2.inner = o2;
  ...
  /// CHECK: StaticFieldSet field_name:MultipleObject.inner_static field_type:Reference ignore_write_barrier:false
  /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference ignore_write_barrier:false
  /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference ignore_write_barrier:true
