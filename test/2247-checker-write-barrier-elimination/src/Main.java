...
public class Main {
  public static void main(String[] args) throws Error {
    ...
    // Object ArraySets can throw since they need a type check so we cannot perform the optimization.
    ...
    // Several sets, multiple receivers. (set obj1, obj2, obj1 and see that the card of obj1 gets eliminated)
    $noinline$testInstanceFieldSetsMultipleReceivers(new Main(), new Object(), new Object(), new Object());
    ...
    // TODO(solanes): show that suspend checks, invokes, or instructions that can throw stop the optimization.
  }
  ...
  /// CHECK: InstanceFieldSet field_name:Main.inner field_type:Reference
  /// CHECK: InstanceFieldSet field_name:Main.inner2 field_type:Reference
  /// CHECK: InstanceFieldSet field_name:Main.inner3 field_type:Reference
  /// CHECK: ; card_table
  ...
  /// CHECK: StaticFieldSet field_name:Main.inner_static field_type:Reference
  /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference
  /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference
  /// CHECK: ; card_table
  ...
  /// CHECK: ; card_table
  /// CHECK-NOT: ; card_table
  private static java.lang.Object[] $noinline$testArraySets(Object[] arr, Object o, Object o2, Object o3) {
    arr[0] = o;
    arr[1] = o2;
    arr[2] = o3;
    return arr;
  ...
  /// CHECK: NewInstance
  /// CHECK: ; card_table
  /// CHECK: InstanceFieldSet field_name:MultipleObject.inner field_type:Reference
  /// CHECK: InstanceFieldSet field_name:MultipleObject.inner field_type:Reference
  /// CHECK: ; card_table
  /// CHECK: InstanceFieldSet field_name:MultipleObject.inner2 field_type:Reference
  /// CHECK: ; card_table
  ...
  /// CHECK: ; card_table
  /// CHECK-NOT: ; card_table
  private static Main $noinline$testInstanceFieldSetsMultipleReceivers(Main m, Object o, Object o2, Object o3) throws Error {
  ...
  /// CHECK: StaticFieldSet field_name:MultipleObject.inner_static field_type:Reference
  /// CHECK: ; card_table
  /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference
  /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference
  /// CHECK: ; card_table
  ...
  /// CHECK: ; card_table
  /// CHECK-NOT: ; card_table
  private static void $noinline$testStaticFieldSetsMultipleReceivers(Object o, Object o2, Object o3) {
  ...
  /// CHECK: ArraySet needs_type_check:false
  /// CHECK: ; card_table
  // Setting the `array_of_arrays`. Note that we can eliminate a `card_table` here too.
  /// CHECK: ArraySet needs_type_check:false
  /// CHECK: ArraySet needs_type_check:false
  /// CHECK: ; card_table
