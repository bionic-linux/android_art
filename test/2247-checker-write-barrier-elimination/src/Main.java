...
public class Main {
    ...
    /// CHECK: InstanceFieldSet field_name:Main.inner field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:true
    /// CHECK: InstanceFieldSet field_name:Main.inner2 field_type:Reference ignore_write_barrier:true write_barrier_being_relied_on:false
    /// CHECK: InstanceFieldSet field_name:Main.inner3 field_type:Reference ignore_write_barrier:true write_barrier_being_relied_on:false
    ...
    /// CHECK: StaticFieldSet field_name:Main.inner_static field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:true
    /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference ignore_write_barrier:true write_barrier_being_relied_on:false
    /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference ignore_write_barrier:true write_barrier_being_relied_on:false
    ...
    /// CHECK: ArraySet needs_type_check:true can_trigger_gc:true ignore_write_barrier:false
    /// CHECK: ArraySet needs_type_check:true can_trigger_gc:true ignore_write_barrier:false
    /// CHECK: ArraySet needs_type_check:true can_trigger_gc:true ignore_write_barrier:false
    ...
    /// CHECK: ArraySet needs_type_check:false can_trigger_gc:false ignore_write_barrier:false
    /// CHECK: ArraySet needs_type_check:false can_trigger_gc:false ignore_write_barrier:true
    /// CHECK: ArraySet needs_type_check:false can_trigger_gc:false ignore_write_barrier:true
    ...
    /// CHECK: InstanceFieldSet field_name:Main.inner field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    /// CHECK: InstanceFieldSet field_name:Main.inner2 field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    /// CHECK: InstanceFieldSet field_name:Main.inner3 field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    ...
    /// CHECK: StaticFieldSet field_name:Main.inner_static field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    ...
    /// CHECK: InstanceFieldSet field_name:MultipleObject.inner field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:true
    /// CHECK: InstanceFieldSet field_name:MultipleObject.inner field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    /// CHECK: InstanceFieldSet field_name:MultipleObject.inner2 field_type:Reference ignore_write_barrier:true write_barrier_being_relied_on:false
    ...
    /// CHECK: StaticFieldSet field_name:MultipleObject.inner_static field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:false
    /// CHECK: StaticFieldSet field_name:Main.inner_static2 field_type:Reference ignore_write_barrier:false write_barrier_being_relied_on:true
    /// CHECK: StaticFieldSet field_name:Main.inner_static3 field_type:Reference ignore_write_barrier:true write_barrier_being_relied_on:false
