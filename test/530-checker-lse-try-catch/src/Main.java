...
public class Main {
  public static void main(String[] args) {
    ...
    assertEquals(
        3, testDifferentFields(new Point(), new Point(), boolean_throw, boolean_other_throw));
  ...
  private static int testDifferentFields(
  ...
  private static int testRedundantStore(
