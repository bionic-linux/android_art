...
class Main {
    ...
    private static class ByteArrayTests {
        ...
        public static byte[] $noinline$test9() {
            byte[] src = new byte[127];
            src = init(src);
        ...
        public static void $noinline$test10(byte[] src, byte[] dst, byte i) {
    ...
    private static class CharArrayTests {
        ...
        public static char[] $noinline$test9() {
            char[] src = new char[150];
            src = init(src);
        ...
        public static void $noinline$test10(char[] src, char[] dst, int i) {
            System.arraycopy(src, 0, dst, 0, i);
        }
    ...
    private static class IntArrayTests {
        ...
        public static int[] $noinline$test9() {
            int[] src = new int[150];
            src = init(src);
        ...
        public static void $noinline$test10(int[] src, int[] dst, int i) {
            System.arraycopy(src, 0, dst, 0, i);
        }
