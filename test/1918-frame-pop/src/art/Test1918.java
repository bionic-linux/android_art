...
public class Test1918 {
  ...
  public static void doRecurTestWith(long env, final int times, int watch_frame) throws Exception {
    ...
    if (target_frame != null) {
      FramePop.notifyFramePop(env, target, target_frame.depth);
    } else {
      System.out.println(
  ...
  public static void run() throws Exception {
    ...
    FramePop.enableFramePopEvent(
        Test1918.class,
        Test1918.class.getDeclaredMethod(
            "handleFramePop", Executable.class, Boolean.TYPE, Long.TYPE),
        null);
    doRecurTestWith(0, 10, 0);
    doRecurTestWith(0, 10, 5);
    doRecurTestWith(0, 10, 10);
    doRecurTestWith(0, 100, 95);
    doRecurTestWith(FramePop.makeJvmtiEnvForFramePop(), 10, 5);
  }
}
