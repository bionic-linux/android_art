...
public class Main {
    ...
    // remaining NullCheck. Similarly, LSE can remove the remaining InstanceFieldGet.
    ...
    // Even when nested we can remove three NullCheck instructions, and GVN can
    // remove the rest. Similarly, LSE can remove the remaining InstanceFieldGet.
