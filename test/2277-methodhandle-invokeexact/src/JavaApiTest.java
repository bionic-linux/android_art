...
public class JavaApiTest extends AbstractInvokeExactTest {
  ...
  private static final MethodHandle FOO_CONFLICT_DEFAULT = null;
  ...
  static {
    try {
      ...
      // FOO_CONFLICT_DEFAULT = MethodHandles.lookup()
      //    .findVirtual(FooConflict.class, "defaultToOverride", methodType(String.class));
  ...
  @Override
  public MethodHandle fooConflictDefault() {
    return FOO_CONFLICT_DEFAULT;
  }
