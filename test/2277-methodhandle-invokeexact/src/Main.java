...
public class Main {
    ...
    private static void $noinline$demo() throws Throwable {
      A a = new A();
      VOID_METHOD.invoke(a);
      VOID_METHOD.invokeExact(a);
    }
    ...
    private static void $noinline$interfaceChecks() throws Throwable {
      ...
      result = (String) FOOBARIMPL_DEFAULT.invoke(instance);
      assertEquals("Bar.defaultToOverride", result);
    ...
    static class FooBarImpl implements Bar {
      @Override
