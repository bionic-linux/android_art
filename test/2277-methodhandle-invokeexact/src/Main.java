...
public class Main {
    ...
    private static void $noinline$testNoArgsCalls() throws Throwable {
      ...
      try {
        ...
        unreachable("Callsite type is (Main$A)V, but MethodHandle is (Main$I)V");
      ...
      try {
        ...
        unreachable("Callsite type is (Main$A)V, but MethodHandle is (Main$A)I");
      } catch (WrongMethodTypeException ignored) {}
    ...
    private static void unreachable(String msg) {
      throw new AssertionError("Unreachable: " + msg);
    }
