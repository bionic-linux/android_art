...
//
// Returned data may be shorted lived: it must be copied before calling
// this method again on any other method within the same ADexFile.
// (it currently long lived, but this is not guaranteed in the future).
//
// Not thread-safe for calls on the same ADexFile instance.
