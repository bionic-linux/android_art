...
struct ADexFile;
typedef struct ADexFile ADexFile; // NOLINT modernize-use-using

struct ADexFile_Method;
typedef struct ADexFile_Method ADexFile_Method; // NOLINT modernize-use-using
...
typedef enum ADexFile_Error ADexFile_Error; // NOLINT modernize-use-using 
