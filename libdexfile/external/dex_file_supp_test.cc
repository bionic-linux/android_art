...
TEST(DexFileTest, get_method_info_callback) {
  ...
  run_test(ADEXFILE_FLAGS_NAMEONLY, "main");
  run_test(ADEXFILE_FLAGS_NAMEWITHCLASS, "Main.main");
  run_test(ADEXFILE_FLAGS_NAMEWITHPARAMETERS, "void Main.main(java.lang.String[])");
}
