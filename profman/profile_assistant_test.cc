...
class ProfileAssistantTest : public CommonRuntimeTest {
 ...
 protected:
  ...
  int CheckCompilationPercentChange(int n_methods_in_cur_profile, int n_classes_in_cur_profile,
                                    int n_methods_in_ref_profile, int n_classes_in_ref_profile) {
    ScratchFile profile;
    ...
    SetupProfile("p1", 1, n_methods_in_cur_profile, n_classes_in_cur_profile, profile,  &info1);
    ProfileCompilationInfo info2;
    SetupProfile("p1", 1, n_methods_in_ref_profile, n_classes_in_ref_profile, reference_profile,
        &info2);
