...
class ProfileAssistantTest : public CommonRuntimeTest {
 ...
 protected:
  ...
  int CheckCompilationPercentChange(int nMethodsInCurProfile, int nClassesInCurProfile,
                                    int nMethodsInRefProfile, int nClassesInRefProfile) {
    ScratchFile profile;
    ...
    SetupProfile("p1", 1, nMethodsInCurProfile, nClassesInCurProfile, profile,  &info1);
    ProfileCompilationInfo info2;
    SetupProfile("p1", 1, nMethodsInRefProfile, nClassesInRefProfile, reference_profile, &info2);
