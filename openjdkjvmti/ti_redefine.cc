...
void Redefiner::ClassRedefinition::UpdateClass(
  ...
  // Notify the jit that all the methods in this class were redefined. Need to do this last since it
  // relies on the dex_file_ being correct (for native methods at least).
