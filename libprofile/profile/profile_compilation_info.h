  ...
  class ItemMetadata {
   public:
    struct InlineCacheInfo {
      ...
      std::set<TypeReference, TypeReferenceValueComparator> classes_;
    };
    ...
    void MergeInlineCacheInfo(const SafeMap<TypeReference, InlineCacheInfo, TypeReferenceValueComparator>& other);

    const SafeMap<TypeReference, InlineCacheInfo, TypeReferenceValueComparator>& GetInlineCache() const {
