 ...
 public:
  class ItemMetadata {
   public:
    ...
    void MergeInlineCacheInfo(const SafeMap<TypeReference, InlineCacheInfo>& other);

    const SafeMap<TypeReference, InlineCacheInfo>& GetInlineCache() const {
   ...
   private:
    ...
    SafeMap<TypeReference, InlineCacheInfo> inline_cache_;
