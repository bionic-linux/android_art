 ...
 public:
  class ItemMetadata {
   public:
    ...
    // Returns the inline cache map for the given method. If there is no inline-cache
    // map this will return empty map.
    void ExtractInlineCacheInfo(
    ...
    SafeMap<std::string, InlineCacheInfo> GetInlineCache() const {
      return inline_cache;
    }
   ...
   private:
    ...
    SafeMap<std::string, InlineCacheInfo> inline_cache;
