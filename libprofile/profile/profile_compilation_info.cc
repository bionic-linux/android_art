...
void FlattenProfileData::ItemMetadata::MergeInlineCacheInfo(const SafeMap<TypeReference, InlineCacheInfo>& other) {
  for (const auto [target, inline_cache_data] : other) {
    ...
    for (const TypeReference& cls : inline_cache_data.classes_) {
