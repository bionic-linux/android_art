    ...
    if (!options_.dump_header_only_) {
      ...
      if (linker != nullptr) {
        ...
        for (size_t i = 0; i < oat_file_.number_of_BCP_dexfiles_; i++) {
          ...
          DumpBssOffsets(os, "ArtMethod", oat_file_.BCP_info[i].method_bss_mapping_);
          DumpBssOffsets(os, "Class", oat_file_.BCP_info[i].type_bss_mapping_);
          DumpBssOffsets(os, "Public Class", oat_file_.BCP_info[i].public_type_bss_mapping_);
          DumpBssOffsets(os, "Package Class", oat_file_.BCP_info[i].package_type_bss_mapping_);
          DumpBssOffsets(os, "String", oat_file_.BCP_info[i].string_bss_mapping_);
        }
      }
    }
