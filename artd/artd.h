...
class ArtdCancellationSignal : public aidl::com::android::server::art::BnArtdCancellationSignal {
 public:
  explicit ArtdCancellationSignal(std::function<remove_noexcept_t<decltype(kill)>> kill_func)
 ...
 private:
  ...
  std::function<remove_noexcept_t<decltype(kill)>> kill_;
};
...
class Artd : public aidl::com::android::server::art::BnArtd {
 public:
  explicit Artd(
      ...
      std::function<remove_noexcept_t<decltype(inotify_init1)>> inotify_init1_func = inotify_init1,
      std::function<remove_noexcept_t<decltype(inotify_add_watch)>> inotify_add_watch_func =
          inotify_add_watch,
      std::function<decltype(PidfdOpen)> pidfd_open_func = PidfdOpen,
      ...
      : options_(std::move(options)),
        ...
        inotify_init1_(std::move(inotify_init1_func)),
        inotify_add_watch_(std::move(inotify_add_watch_func)),
        pidfd_open_(std::move(pidfd_open_func)),
 ...
 private:
  ...
  const std::function<remove_noexcept_t<decltype(inotify_init1)>> inotify_init1_;
  const std::function<remove_noexcept_t<decltype(inotify_add_watch)>> inotify_add_watch_;
  const std::function<decltype(PidfdOpen)> pidfd_open_;
  const std::function<remove_noexcept_t<decltype(poll)>> poll_;
