...
public class Dex2OatStatsReporter {
    public static void report(int appId, @NonNull String compilerFilter,
            ...
            @NonNull DetailedDexInfo dexInfo, @NonNull String isa, int resultStatus,
            int resultExitCode, int resultSignal, long artifactsSize, long compilationTime) {
        ArtStatsLog.write(ArtStatsLog.ART_DEX2OAT_REPORTED, appId,
                ...
                resultStatus, resultExitCode, resultSignal, (int) artifactsSize / 1024,
                (int) compilationTime);
    }
