...
public class PreRebootDriver {
    ...
    private void runFromChroot(@NonNull CancellationSignal cancellationSignal,
        ...
        // are used. Be careful not to pass an instance of a class in the old `service-art.jar` to
        // methods in the new `service-art.jar` (across the API boundary in
        // `PreRebootManagerInterface`).
