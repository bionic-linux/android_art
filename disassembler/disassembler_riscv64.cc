...
void DisassemblerRiscv64::Printer::Print32BinOpImm(uint32_t insn32) {
  ...
  } else if (funct6 == 0x12u && (funct3 == /*BCLRI*/ 0x1u || funct3 == /*BCLRI*/ 0x5u)) {
    os_ << ((funct3 == /*BCLRI*/ 0x1u) ? "bclri" : "bexti");
  } else if (funct6 == 0x1Au && funct3 == 0x1u /*BINVI*/) {
    os_ << "binvi";
  } else if (funct6 == 0xAu && funct3 == 0x1u /*BSETI*/) {
    os_ << "bseti";
  } else {
...
void DisassemblerRiscv64::Printer::Print32BinOp(uint32_t insn32) {
  ...
  } else if (high_bits == 0x24000000u && (funct3 == /*BCLR*/ 0x1u || funct3 == /*BEXT*/ 0x5u)) {
    os_ << ((funct3 == /*BCLR*/ 0x1u) ? "bclr" : "bext");
  } else if (high_bits == 0x34000000u && funct3 == /*BINV*/ 0x1u) {
    os_ << "binv";
  } else if (high_bits == 0x14000000u && funct3 == /*BSET*/ 0x1u) {
    os_ << "bset";
  } else {
    bool bad_high_bits = false;
