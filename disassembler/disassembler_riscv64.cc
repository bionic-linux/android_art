...
void DisassemblerRiscv64::Printer::Print32BinOpImm(uint32_t insn32) {
  ...
  } else if (!narrow && funct6 == 0x12u && (funct3 == /*BCLRI*/ 0x1u || funct3 == /*BCLRI*/ 0x5u)) {
...
void DisassemblerRiscv64::Printer::Print32BinOp(uint32_t insn32) {
  ...
  if (high_bits == 0x40000000u && funct3 == /*SUB*/ 0u && rs1 == Zero) {
    ...
    os_ << "zext.w " << XRegName(rd) << ", " << XRegName(rs1);
             ...
             (funct3 == /*BCLR*/ 0x1u || funct3 == /*BEXT*/ 0x5u)) {
    os_ << ((funct3 == /*BCLR*/ 0x1u) ? "bclr" : "bext");
  } else if (!narrow && high_bits == 0x68000000u && funct3 == /*BINV*/ 0x1u) {
    os_ << "binv";
  } else if (!narrow && high_bits == 0x28000000u && funct3 == /*BSET*/ 0x1u) {
    os_ << "bset";
  } else {
    bool bad_high_bits = false;
