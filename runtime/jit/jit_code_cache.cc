...
uint8_t* JitCodeCache::CommitCodeInternal(Thread* self,
  ...
  WaitForPotentialCollectionToCompleteRunnable(self);
  {
    ...
    if (art::membarrier(art::MembarrierCommand::kPrivateExpeditedSyncCore) != 0) {
      // If kernel version is older than 4.16, the command won't work. It might cause a data race
      // bwtween cores. memcmp can work around this problem.
