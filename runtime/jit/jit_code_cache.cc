...
JitCodeCache* JitCodeCache::Create(size_t initial_capacity,
  ...
  // host which does not work with ashmem. Android's simpleperf does
  // not understand JIT frames whether or not ashmem is used here.
  ...
  //
  //          +----------------+
  //          :     Padding    :  post_code_map
  //          +----------------+
  //          |    JIT Code    |  code_map
  //          +----------------+
  //          :     Padding    :  pre_code_map
  //          +----------------+
  //          |    JIT Data    |  data_map
  //          +----------------+
  //
