...
template <typename T>
bool JitCodeCache::IsDataAddress(const T* raw_addr) const {
  return IsAddressType(raw_addr, data_map_.get(), "Data");
}

template <typename T>
bool JitCodeCache::IsExecutableAddress(const T* raw_addr) const {
  return IsAddressType(raw_addr, executable_code_map_.get(), "Executable");
}

template <typename T>
bool JitCodeCache::IsWritableAddress(const T* raw_addr) const {
...
template <typename T>
T* JitCodeCache::ToWritableAddress(const T* executable_address) const {
  CHECK(IsExecutableAddress(executable_address));
