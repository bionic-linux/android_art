...
class JitCodeCache {
 public:
  ...
  EXPORT void DoCollection(Thread* self, bool force) REQUIRES(!Locks::jit_lock_);
 ...
 private:
  ...
  // Condition to wait on druing collection and for accessing weak references in inline caches.
