...
class ProfileCompilationInfo {
 public:
  ...
  bool ContainsClassType(const DexFile& dex_file, uint16_t class_type_idx) const;
 ...
 private:
  ...
  bool AddClassTypeIndex(const std::string& dex_location, uint32_t checksum, uint16_t type_idx);
