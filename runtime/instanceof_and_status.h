...
BITSTRUCT_DEFINE_START(InstanceOfAndStatusNew, BitSizeOf<BitString::StorageType>())
  BitStructField<ClassStatus, /*lsb*/0, /*width*/NonNumericBitSizeOf<ClassStatus>()> status_;
  BitStructField<InstanceOfData, /*lsb*/NonNumericBitSizeOf<ClassStatus>()> instance_of_;
