...
class DexFile {
 public:
  ...
  enum HeaderExtensionType : uint16_t {
    kDexHeaderExtensionMethodType   = 0x0000,
    kDexHeaderExtensionMethodHandle = 0x0001,
    kDexHeaderExtensionLast = kDexHeaderExtensionMethodHandle,
  };
  ...
  struct MethodTypeItem {
    uint16_t proto_id_idx_;
   private:
    DISALLOW_COPY_AND_ASSIGN(MethodTypeItem);
  };
