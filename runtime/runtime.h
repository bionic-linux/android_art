...
class Runtime {
 public:
  ...
  void SetHiddenApiEnforcementPolicy(hiddenapi::ApiEnforcementPolicy policy) {
    hidden_api_check_policy_ = policy;
  }

  hiddenapi::ApiEnforcementPolicy GetHiddenApiEnforcementPolicy() const {
    return hidden_api_check_policy_;
  }
 ...
 private:
  ...
  hiddenapi::ApiEnforcementPolicy hidden_api_check_policy_;
