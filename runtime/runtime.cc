...
Runtime::Runtime()
    : resolution_method_(nullptr),
      ...
      safe_mode_(false),
      hidden_api_check_policy_(hiddenapi::ApiEnforcementPolicy::kNone),
...
bool Runtime::Init(RuntimeArgumentMap&& runtime_options_in) {
  ...
  hidden_api_check_policy_ = do_hidden_api_checks
                           ? hiddenapi::ApiEnforcementPolicy::kBlacklistOnly
                           : hiddenapi::ApiEnforcementPolicy::kNone;
