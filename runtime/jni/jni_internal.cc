...
ALWAYS_INLINE static bool ShouldDenyAccessToMember(T* member, Thread* self)
  ...
  // The native surface of the Core Platform API is not annotated in the Java sources
  // (b/124338141). The assumption is that a native caller in libnativehelper.so always
  // has access to the APIs that the module provides.
