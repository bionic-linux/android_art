...
class JNIEnvExt : public JNIEnv {
 public:
  ...
  LIBART_PROTECTED jobject NewLocalRef(mirror::Object* obj) REQUIRES_SHARED(Locks::mutator_lock_);
  LIBART_PROTECTED void DeleteLocalRef(jobject obj) REQUIRES_SHARED(Locks::mutator_lock_);
  ...
  LIBART_PROTECTED static void SetTableOverride(const JNINativeInterface* table_override)
  ...
  // if it is not null.
  LIBART_PROTECTED static const JNINativeInterface* GetFunctionTable(bool check_jni)
