...
// We want type safety for DispatchEvent, in the sense of exactly matching the JVMTI event function
// types, prohobiting automatic coercion. So we do not return a functor, but call a function
// pointer directly. The design of GetCallBack ensures that only matching arguments will type-check.
