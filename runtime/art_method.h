...
class ArtMethod FINAL {
 ...
 protected:
  ...
  std::atomic<std::uint32_t> access_flags_;  // 4
  ...
  struct PtrSizedFields {
    ...
    ArtMethod** dex_cache_resolved_methods_;  // 20 or 24

    // Short cuts to declaring_class_->dex_cache_ member for fast compiled code access.
    GcRoot<mirror::Class>* dex_cache_resolved_types_;  // 24 or 32
    ...
    // the interpreter.
    void* entry_point_from_quick_compiled_code_;  // 32 or 48
  } ptr_sized_fields_;
