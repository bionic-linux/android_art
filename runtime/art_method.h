...
class ArtMethod FINAL {
 public:
  ...
  bool IsMiranda() {
    // The kAccMiranda flag is used with a different meaning for native methods,
  ...
  bool IsFastNative() {
    ...
    // The kAccFastNative flag is used with a different meaning for non-native methods,
    // so we need to check the kAccNative flag as well.
  ...
  bool IsCriticalNative() {
    // The presence of the annotation is checked by ClassLinker and recorded in access flags.
    // The kAccCriticalNative flag is used with a different meaning for non-native methods,
    // so we need to check the kAccNative flag as well.
  ...
  bool SkipAccessChecks() {
    // The kAccSkipAccessChecks flag is used with a different meaning for native methods,
    // so we need to check the kAccNative flag as well.
