...
class InstructionSetFeatures {
 public:
  ...
  LIBART_PROTECTED static std::unique_ptr<const InstructionSetFeatures> FromVariant(
  ...
  LIBART_PROTECTED static std::unique_ptr<const InstructionSetFeatures> FromVariantAndHwcap(
      InstructionSet isa, const std::string& variant, std::string* error_msg);

  // Parse a bitmap for the given isa and create an InstructionSetFeatures.
  LIBART_PROTECTED static std::unique_ptr<const InstructionSetFeatures> FromBitmap(InstructionSet isa,
                                                                         uint32_t bitmap);

  // Turn C pre-processor #defines into the equivalent instruction set features for kRuntimeISA.
  LIBART_PROTECTED static std::unique_ptr<const InstructionSetFeatures> FromCppDefines();
  ...
  LIBART_PROTECTED std::unique_ptr<const InstructionSetFeatures> AddFeaturesFromString(
  ...
  LIBART_PROTECTED const Arm64InstructionSetFeatures* AsArm64InstructionSetFeatures() const;

  // Down cast this Riscv64InstructionFeatures.
  LIBART_PROTECTED const Riscv64InstructionSetFeatures* AsRiscv64InstructionSetFeatures() const;
...
LIBART_PROTECTED std::ostream& operator<<(std::ostream& os, const InstructionSetFeatures& rhs);
