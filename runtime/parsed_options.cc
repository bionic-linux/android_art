...
void ParsedOptions::Usage(const char* fmt, ...) {
  ...
  UsageMessage(stream, "  -verbose:tag ('agents', 'class', 'collector', 'compiler', 'deopt',\n"
                       "    'dex', 'gc', 'heap', 'image', 'interpreter', 'jdwp', 'jit', 'jni',\n"
                       "    'monitor', 'oat', 'profiler', 'signals', 'simulator', 'startup',\n"
                       "    'systrace-locks', 'third-party-jni', 'threads', 'verifier', or\n"
                       "    'verifier-debug')\n");
