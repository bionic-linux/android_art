...
class RegTypeCache {
 public:
  ...
  // Cannot be used for reference types other than `JavaLangObject()`; all other kinds
  // (undefined, conflict, primitive and constant types) are have pre-initialized types.
