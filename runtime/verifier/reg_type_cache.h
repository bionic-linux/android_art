...
class RegTypeCache {
 public:
  ...
  // Cannot be used for reference types other than `JavaLangObject()`; all non-reference
  // kinds (undefined, conflict, primitive and constant types) have pre-initialized types.
