...
class MANAGED Class FINAL : public Object {
 public:
  ...
  void SetInstanceOfAndStatus(InstanceOfAndStatus new_value)
      REQUIRES_SHARED(Locks::mutator_lock_);

  bool TrySetInstanceOfAndStatus(InstanceOfAndStatus old_value, InstanceOfAndStatus new_value)
      REQUIRES_SHARED(Locks::mutator_lock_);
  ...
  void AssignSelfBitstring() REQUIRES_SHARED(Locks::mutator_lock_) REQUIRES_SHARED(Locks::bitstring_lock_);

  // Initialize the bitstring and assign the bistring for its super class for klass.
 ...
 private:
  ...
  // class itself is in overflowed state, or it has used up all bitstring values for children,
