...
class MANAGED Class FINAL : public Object {
 public:
  ...
  Status GetStatus() REQUIRES_SHARED(Locks::mutator_lock_) {
    // Avoid including "instanceof_and_status.h" to get the field.
    // The ClassStatus is always in the least-significant bits of status_.
    return static_cast<Status>(static_cast<uint8_t>(static_cast<uint32_t>(GetField32Volatile<kVerifyFlags>(StatusOffset())) & 0xff));
  }
 ...
 private:
  ...
  // See the real definition in instanceof_and_status.h
