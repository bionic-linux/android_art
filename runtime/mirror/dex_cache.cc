...
void DexCache::ReclaimMemory() {
  ReclaimMemoryInternal(resolved_fields_array_, NumResolvedFieldsArray() * sizeof(ArtField*));
  ReclaimMemoryInternal(resolved_method_types_array_, NumResolvedMethodTypesArray() * sizeof(GcRoot<mirror::MethodType>));
  ReclaimMemoryInternal(resolved_methods_array_, NumResolvedMethodsArray() * sizeof(ArtMethod*));
  ReclaimMemoryInternal(resolved_types_array_, NumResolvedTypesArray() * sizeof(GcRoot<mirror::Class>));
  ReclaimMemoryInternal(strings_array_, NumStringsArray() * sizeof(GcRoot<mirror::String>));
}
