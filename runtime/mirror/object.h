...
class MANAGED LOCKABLE Object {
 ...
 private:
  ...
  template<VerifyObjectFlags kVerifyFlags>
  ALWAYS_INLINE void VerifyRead(ObjPtr<mirror::Object> value) {
  ...
  template<VerifyObjectFlags kVerifyFlags>
  ALWAYS_INLINE void VerifyWrite(ObjPtr<mirror::Object> value) {
