...
class MANAGED String FINAL : public Object {
 public:
  ...
  static bool AllASCII(const char* chars) SHARED_REQUIRES(Locks::mutator_lock_);
  static bool AllASCII(const uint16_t* const chars, const int length) SHARED_REQUIRES(Locks::mutator_lock_);
