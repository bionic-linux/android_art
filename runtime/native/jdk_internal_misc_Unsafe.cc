...
static jboolean Unsafe_CASObject(JNIEnv* env, jobject, jobject javaObj, jlong offset,
  ...
  if (kUseReadBarrier) {
    ...
    ReadBarrier::Barrier<mirror::Object, kIsVolatile, kWithReadBarrier,
...
static jboolean Unsafe_compareAndSetObject(JNIEnv* env, jobject obj, jobject javaObj, jlong offset,
                                            jobject javaExpectedValue, jobject javaNewValue) {
  return Unsafe_CASObject</*kIsVolatile=*/ true>(
      env, obj, javaObj, offset, javaExpectedValue, javaNewValue);
}
...
static jboolean Unsafe_compareAndSwapObject(JNIEnv* env, jobject obj, jobject javaObj, jlong offset,
  ...
  return Unsafe_CASObject</*kIsVolatile=*/ false>(
      env, obj, javaObj, offset, javaExpectedValue, javaNewValue);
}
