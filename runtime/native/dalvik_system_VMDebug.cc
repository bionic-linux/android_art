...
static jobject VMDebug_locateJavaMethod(JNIEnv* env,
                                        jclass,
                                        jclass javaClass,
                                        jstring jreturnDot,
                                        jstring jclassDot,
  ...
  std::string returnDot;
  {
    ScopedUtfChars chars(env, jreturnDot);
    if (env->ExceptionCheck()) {
      return NULL;
    }
    returnDot = chars.c_str();
  }
  ...
  for (const ClassAccessor::Method& method : accessor.GetMethods()) {
    ...
    if (pretty_method.find(returnDot + " " + classDot + methodDot) == std::string::npos) {
      continue;
    } else {
...
static JNINativeMethod gMethods[] = {
    ...
    NATIVE_METHOD(
        VMDebug,
        locateJavaMethod,
        "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/android/"
        "JavaMethodLocation;"),
};
