...
static jobject VMDebug_getJavaMethodExecutableOffsetNative(JNIEnv* env,
  ...
  size_t odex_offset = reinterpret_cast64<jlong>(elf_begin);
  size_t method_offset = reinterpret_cast64<jlong>(oat_method_quick_code) - odex_offset;
  ...
  if (clazz == nullptr) {
    soa.Self()->ThrowNewExceptionF(
        ...
        "Could not find dalvik/system/VMDebug$JavaMethodExecutableOffset");
    return nullptr;
  }
