...
ALWAYS_INLINE static bool ShouldEnforceHiddenApi(Thread* self)
  ...
  hiddenapi::ApiEnforcementPolicy policy = Runtime::Current()->GetHiddenApiEnforcementPolicy();
  return policy != hiddenapi::ApiEnforcementPolicy::kNone &&  IsCallerInBootClassPath(self);
}
