...
ObjPtr<mirror::Class> ClassLinker::DefineClass(Thread* self,
  ...
  // some Runtime modules. Prevent definition of classes in app class loader that could
  // clash with these modules as these classes could be resolved differently at runtime.
