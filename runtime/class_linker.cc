...
bool ClassLinker::AddImageSpace(
  ...
  int32_t expected_image_roots = app_image ? ImageHeader::kImageRootsMax
                                           : (ImageHeader::kImageRootsMax - 1u);
  if (header.GetImageRoots()->GetLength() != expected_image_roots) {
    *error_msg = StringPrintf("Expected %d image roots but got %d",
