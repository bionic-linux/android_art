...
class FixupInternVisitor {
 public:
  explicit FixupInternVisitor(gc::accounting::ContinuousSpaceBitmap* visited)
      : visited_(visited) {}
  ...
  void operator()(mirror::Object* obj) const
    ...
    obj->VisitReferences<true, kVerifyNone, kWithoutReadBarrier>(
        *this,
        *this);
  }
...
bool ClassLinker::UpdateAppImageClassLoadersAndDexCaches(
  ...
  }
  {
    ...
    const auto target_base = space->GetMemMap()->Begin();
    const auto bitmap = space->GetMarkBitmap();  // bitmap of objects
    std::unique_ptr<gc::accounting::ContinuousSpaceBitmap> visited_bitmap(  // bitmap of strings
        gc::accounting::ContinuousSpaceBitmap::Create("Intern String bitmap",
                                                      target_base,
    ...
    FixupInternVisitor fixup_intern_visitor(visited_bitmap.get());
