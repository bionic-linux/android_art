...
static ALWAYS_INLINE inline mirror::Object* artAllocObjectFromCode(mirror::Class* klass, Thread* self)
...
extern "C" void* art_quick_alloc_object_with_access_check##suffix(mirror::Class* klass); \
...
extern "C" void* art_quick_alloc_object_with_access_check##suffix##_instrumented(mirror::Class* klass); \
