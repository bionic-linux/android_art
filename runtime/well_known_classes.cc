...
void WellKnownClasses::InitFieldsAndMethodsOnly(JNIEnv* env) {
  ...
  java_lang_Throwable_cause =
      CacheField(j_l_Throwable, /*is_static=*/ false, "cause", "Ljava/lang/Throwable;");
  java_lang_Throwable_detailMessage =
      CacheField(j_l_Throwable, /*is_static=*/ false, "detailMessage", "Ljava/lang/String;");
  java_lang_Throwable_stackTrace =
      CacheField(j_l_Throwable, /*is_static=*/ false, "stackTrace", "[Ljava/lang/StackTraceElement;");
  java_lang_Throwable_stackState =
      CacheField(j_l_Throwable, /*is_static=*/ false, "backtrace", "Ljava/lang/Object;");
  java_lang_Throwable_suppressedExceptions =
      CacheField(j_l_Throwable, /*is_static=*/ false, "suppressedExceptions", "Ljava/util/List;");
