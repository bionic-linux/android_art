...
class MarkCompact final : public GarbageCollector {
 public:
  ...
  // Called by Heap::PreZygoteFork() to reset generational heap markers.
  void PreZygoteFork();
 ...
 private:
  ...
  // address and return it. [begin, end) is a range in moving-space.
  ...
  ALWAYS_INLINE bool VerifyRootSingleUpdate(void* root,
                                            ...
                                            const RootInfo& info)
      REQUIRES_SHARED(Locks::mutator_lock_);
  // Update the given root with post-compact address and return it. [begin, end)
  // is a range in moving-space.
  ...
  // End of compacted space. Used for computing post-compact addr of black
