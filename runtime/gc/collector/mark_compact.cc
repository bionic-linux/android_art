...
void MarkCompact::PrepareForMarking(bool pre_marking) {
  ...
  for (const auto& space : GetHeap()->GetContinuousSpaces()) {
    if (space->GetGcRetentionPolicy() == space::kGcRetentionPolicyNeverCollect ||
      ...
      if (young_gen_) {
        // Necessary to age cards as they contain old-to-young references.
        // TODO: consider clearing cards in [old_gen_end_, moving_space_end_)
        // range of moving-space as we don't need those cards.
...
// TODO: We need to find the cards in the mid-gen, which is going to be consumed
// into old-gen after this GC, for dirty cards (dirtied after marking-pause and
// until compaction pause) and dirty the corresponding post-compact cards.
 ...
 public:
  ALWAYS_INLINE explicit RefFieldsVisitor(MarkCompact* const mark_compact, mirror::Object* obj)
      : mark_compact_(mark_compact),
        ...
        // becasue later in PrepareForCompaction() we will align-down the
...
void MarkCompact::ScanObject(mirror::Object* obj) {
  ...
  // native-roots durig compaction, that has to be captured during marking.
  //
