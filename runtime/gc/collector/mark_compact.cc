...
// together.
// Concurrent compaction termination logic depends on kernel having
// fault-retry feature (allowing repeated faults on the same page), which was
// introduced in 5.7. On target this feature is backported on all kernels where
